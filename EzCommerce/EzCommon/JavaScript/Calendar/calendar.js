...
Zapatec.Calendar.cellClick = function(el, ev) {
	...
	}else if (typeof el.navtype == "undefined") {
...
Zapatec.Calendar.prototype.create = function (_par) {
	...
	//kp modified
	cell = hh(Zapatec.Calendar.i18n("CLEAR"), this.numberMonths,"KP");
	cell.ttip = Zapatec.Calendar.i18n("CLEAR_TIP");
	//kp modified end
	
	cell = hh(Zapatec.Calendar.i18n("SEL_DATE"), this.weekNumbers ? (7 * this.numberMonths) : (6 * this.numberMonths), 300);
	cell.className = "ttip";
