...
<!--
	...
	function onLoad()
	{
		...
		//alert(ezcheckapplet.getJavaVersion())
		if(jQuery.browser.msie)
		{
				userAgent = userAgent.substring(0,userAgent.indexOf('.'));
				version = userAgent;
				document.all['browserChk'].innerHTML = '<li>Microsoft Windows with Internet Explorer 5.5 or later<br><span class="message">Verified OK (MSIE  '+ $.browser.version +' )</span></li>';
		}
		if($.browser.chrome)
		{
				document.all['browserChk'].innerHTML = '<li>You are Using Google Chrome <br><span class="message">Verified OK (Chrome   '+ $.browser.version +')</span></li>';
		}
		if($.browser.mozilla)
		{
						document.all['browserChk'].innerHTML = '<li> You are Using FireFox  <br><span class="message">Verified OK (Chrome   '+ $.browser.version +')</span></li>';
		}
		if($.browser.safari)
		{
						document.all['browserChk'].innerHTML = '<li>You are Using Safari  <br><span class="message">Verified OK (Chrome   '+ $.browser.version +')</span></li>';
		}
		if($.browser.opera)
		{
						document.all['browserChk'].innerHTML = '<li>You are Using Opera  <br><span class="message">Verified OK (Chrome   '+ $.browser.version +')</span></li>';
		}
	...
	function storeASTTestCookie()
	{
		if (!Get_Cookie('ASTTestCookie'))
		Set_Cookie('ASTTestCookie','ASTTestCookie');
	}
...
<Tr >
			...
			<tr>
					<td style="background-color:'F3F3F3'">
							...
							<p><b>Your web browser configuration has been checked for minimum requirements necessary to use American Standards Business portal.</b></p>
			...
			<h4>Recommended</h4>
			<ol>
					<li>256Kbs or greater network connection</li>
