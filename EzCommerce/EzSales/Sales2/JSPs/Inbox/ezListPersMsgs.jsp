...
<% String display_header ="Mail Box"; %>
						...
						<Tr>
							<Th valign="top" align="center" colspan=4>
								<font size="2" ><b>MESSAGES IN &nbsp;&nbsp;<%=folderName.toUpperCase()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font>
			                    	...
			                    	<Tr>
							<Td align="center" class="displayheaderback"><a href="ezListPersMsgs.jsp?type=allmess&FolderName=<%=folderName%>&FolderID=<%=folderID%>"  style="text-decoration:none;cursor:hand"  title="all messages" <%=statusbar%>><b>All Messages &nbsp;</b></a></Td>
			                    	  	<Td align="center" class="displayheaderback"><a href="ezListPersMsgs.jsp?type=newmess&msgFlag=1&FolderName=<%=folderName%>&FolderID=<%=folderID%>"  title="new messages" <%=statusbar%> style="text-decoration:none" class="mailcell"><b>New Messages</b></a></Td>
<%	
...
%>
			      	       ...
			      	       <Td width="30%" align="left"><a style="text:decoration:none" href="ezPersMsgDetails.jsp?MessageID=<%=retMsgList.getFieldValueString(i,MSG_ID).trim()%>&FolderName=<%=folderName%>" <%=statusbar%>><%=firstname%></Td>
			              <Td width="30%" align="left">&nbsp;
<%
	     					String sub=retMsgList.getFieldValueString(i,MSG_SUBJECT);
