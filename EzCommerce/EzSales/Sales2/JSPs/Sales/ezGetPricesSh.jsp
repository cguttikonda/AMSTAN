...
<%
	...
	if(backFlag==null || "null".equals(backFlag))
		backFlag = "";
		
	String frameFlg = request.getParameter("frameFlg");
	if(frameFlg==null || "null".equals(frameFlg))
		frameFlg = "";
	...
	if("SP".equals(shippingTypeValue))
	{
		shippingTypeValue = "";
		shippingType = "";
		shippingTypeDesc = "";
	...
	String vendorCatalog[]  = request.getParameterValues("vendorCatalog");
	...
	int TotalCount = 0;
	if(product_1!=null)
		TotalCount = product_1.length;
	
	log4j.log("TotalCountTotalCount::"+TotalCount+"-->"+desiredDate_1.length+"-->"+desiredQty_1.length,"W");
	...
	for(int h=0;h<rCount;h++)
	{
		...
		log4j.log(itemMatId+"  <<itemMatId>>>>>>"+itemVendorCatalog+"¥"+itemBrand+"¥"+itemListPrice+"¥"+itemCode+"¥"+itemEanUPC+"¥"+itemmmFlag+"¥"+itemDiscCode+"¥"+itemMfrCode+"¥"+itemMfrPartNo+"¥"+itemWeight,"I");
		try{
		...
		itemVendorCatalogs.put(itemMatId,itemVendorCatalog+"¥"+itemBrand+"¥"+itemListPrice+"¥"+itemCode+"¥"+itemEanUPC+"¥"+itemmmFlag+"¥"+itemDiscCode+"¥"+itemMfrCode+"¥"+itemMfrPartNo+"¥"+itemWeight);
...
<jsp:forward page="ezConfirmOrderSH.jsp">  
	...
	<jsp:param name="scDocNr"  value="<%=SCDocNr%>"/>
	...
	<jsp:param name="specialShIns" value="<%=specialShIns%>"/>  
