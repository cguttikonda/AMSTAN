...
%>
	<Tr>
		...
		<input type="text" size="18" class="InputBox" name="product" value="<%=myMatCode%>" tabindex=<%=count%>  onBlur="entryOut(this.value,'<%=i%>');" onKeyUp="SendQuery(this.value,'prod<%=i%>','A','<%=i%>')"  autocomplete="off" id='prod<%=i%>'>
		</Td>
