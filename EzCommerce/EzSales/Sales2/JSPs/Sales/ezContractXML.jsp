...
try{
	...
	iParams.setTransactionGrp("4");
	iParams.setStatusFlag("A");
	...
	if(cnt==0)
	{
		out.println("<row id='"+cnt+"'></row>");
			...
			for(int i=0;i<cnt;i++)
			{
				...
				if("CU".equals(roleBO))
				{
					out.println("<row id='"+soNumber+"'><cell><![CDATA[<nobr><a href='../Sales/ezBackWaitContractDisplay.jsp?SONumber="+soNumber+"&amp;FromDate="+tfd+"&amp;ToDate="+sttd+"&amp;SoldTo="+soCust+"&amp;status=C&amp;pageUrl=BackOrder&amp;PODATE=&amp;orderType=Open'>"+tempsoNumber+"</a></nobr>]]></cell><cell>"+docDate+"</cell><cell>"+pono+"</cell><cell>"+podate+"</cell><cell>"+netValue+"</cell></row>");
				}
				else
				{
					out.println("<row id='"+soNumber+"'><cell><![CDATA[<nobr><a href='../Sales/ezBackWaitContractDisplay.jsp?SONumber="+soNumber+"&amp;FromDate="+tfd+"&amp;ToDate="+sttd+"&amp;SoldTo="+soCust+"&amp;status=C&amp;pageUrl=BackOrder&amp;PODATE=&amp;orderType=Open'>"+tempsoNumber+"</a></nobr>]]></cell><cell>"+docDate+"</cell><cell>"+pono+"</cell><cell>"+podate+"</cell><cell>"+netValue+"</cell><cell>"+cuname+"</cell></row>");
				}
