...
<%
		...
		}else
		{
			...
			toFile = "../Sales/ezBackEndContractDetails.jsp?SONumber=" + request.getParameter("SONumber")+"&PODATE="+ request.getParameter("PODATE")+"&netValue="+request.getParameter("netValue") + "&orderType=" + request.getParameter("orderType")+"&status=" + request.getParameter("status")+"&newFilter="+request.getParameter("newFilter")+"&FromDate="+request.getParameter("FromDate")+"&ToDate="+request.getParameter("ToDate");
		}
%>
	function fun1()
	{
