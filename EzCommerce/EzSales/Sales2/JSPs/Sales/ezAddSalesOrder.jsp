...
<%
	...
	String SoldTo	 = request.getParameter("soldTo");
	 ...
	 if(SoldTo!=null && !"null".equals(SoldTo))
	  ...
	  if(defSoldTo!=null && !"null".equals(defSoldTo))
	  	defSoldTo = defSoldTo.trim();	
	...
	String[] VC = request.getParameterValues("vendCatalog");
	String[] MID = request.getParameterValues("matId");
	...
	String [] vendCatalogs = new String[p.length];
	String [] matIDs = new String[p.length];
