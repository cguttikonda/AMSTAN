...
<Div id='inputDiv' style='position:relative;align:center;top:4%;width:100%;height:40%'>
...
<%
	...
	{
		out.println("<a style='color:#660000'    href=\"../Sales/ezListSalesOrders.jsp?newFilter=Y&orderStatus='TRANSFERED'&SearchType=&RefDocType=P\" onMouseover=\"window.status=' '; return true\" onMouseout=\"window.status=' ';  return true\"><span class=alertcell><b>"+transferred  +"&nbsp;New Accepted Orders </b></span></a>");
	}
%>
		</Td>
		<Td width="10%" style='background:#F3F3F3'>&nbsp;</Td>
