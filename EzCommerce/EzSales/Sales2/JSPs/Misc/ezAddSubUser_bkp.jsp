...
<%
		...
		while(enum2SA.hasMoreElements())
		{
			...
			if("VONLY".equals(enum2Key)) checked = "checked";
%>
...
%>
	...
	<Div id="theads">
	<Table  width="89%"  id="tabHead"  align=center border=0 borderColorDark=#ffffff borderColorLight=#006666 cellPadding=2 cellSpacing=0 >
     	<Tr align="center">
