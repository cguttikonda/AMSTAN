...
<%@ include file="../../../Includes/JSPs/Cnet/iCnetSearch.jsp"%>
<html>
<head>
...
<Script>
	...
	function funICList()
	{
		document.myForm.action="ezListCnetCategories.jsp";
		document.myForm.submit();
	}
</Script>
...
<%				
				...
				{
					mfrNo = retMfr.getFieldValueString(i,"MfID");
					mfrDesc = retMfr.getFieldValueString(i,"Text");
