...
<head>
	...
	.inputbox {
		font-size: 10px; 
		border-right:#227A7A 1px inset;
		border-top: white 1px inset;
		border-left: white 1px inset;
		border-bottom: #227A7A 1px inset;
...
<Script>
	...
	function openDetails(prodID,imagePath)   
	{
		...
		var ret = window.showModalDialog("ezCnetProdDetails.jsp?prodID="+prodID+"&imagePath="+imagePath,argsVariable,"dialogWidth:800px; dialogHeight:400px; center:yes");
	}
	function goToCatDef()
	{
		document.myForm.atrvalstr.value = ""
...
<%
 	if(rSet!=null){
		...
		if("Y".equals(isCatUser))
 		...
 		//out.println("tableclass"+tableclass);
...
%>
		<font color="#116FAF"><b>Brand&nbsp;:&nbsp;</b></font>
...
%>
	<tr>	
 		...
 		<td style="vertical-align:bottom" align="center" width="35%">&nbsp;
 			<a title="Click here to Filter Products" href="JavaScript:filterByProductLine('<%=categoryID%>','A00600','Product Line','1')"><font color="red"><b>Filter By Series</b></font></a>	
 		</td>
 		<td style="vertical-align:bottom;text-align:right" align="center" width="35%" nowrap>
...
<%
		...
		//{
%>
			<!--<Strong><font color="#116FAF">Brand : <font color="black"><%=mfrDesc%></font>&nbsp;<a href="#" onClick="removeMfr()"><img style="valign:bottom" src="../../../../EzCommon/Images/Common/remove.gif" height="10" width="10" border=0  style='cursor:hand'></a></font></Strong>&nbsp;&nbsp;-->
<%
		//} 
%>					
	<!--</td>
...
%>
		...
		<input type="hidden" name="manfId_<%=rowNum%>" value="<%=manfId%>">
		<input type="hidden" name="MfrPartNo_<%=rowNum%>" value="<%=MfrPartNo%>">
		<input type="hidden" name="mfrName_<%=rowNum%>" value="<%=(rsData.getColumn8()).toString()%>">
...
<%                      
		...
		{
%>
			<img src="<%=imgPath%>" height="38" width="50" border=none onMouseOver="zoomToggle('100px','76px','100px','76px',this)" onMouseOut="zoomToggle('50px','38px','50px','38px',this)">
...
%> 			
	...
	<display:column title="Brand"  sortable="true" headerClass="sortable" style="width:16%;height:50;text-align:left">
	...
	<a href="#" title="Click here to view ATP" onClick="getATP1('<%=rowNum%>')" ><image src="/CRI/EzCommerce/EzSales/Sales2/Images/atp.gif" /></a>
	</display:column>
</display:table> 
<%
 	}else{
