...
////  ADD HEADER
	...
	System.out.println("ezAddDispatchInfoezAddDispatchInfoezAddDispatchInfoezAddDispatchInfo=======>BEFORE");
	dispInfoManager.ezAddDispatchInfo(ezcParams);
	System.out.println("ezAddDispatchInfoezAddDispatchInfoezAddDispatchInfoezAddDispatchInfo=======>AFTER");
	...
	mail.ezSendMail();
	session.putValue("EzMsg","Dispatch Info. have been Added successfully");
	
	*/
	
	//response.sendRedirect("../DeliverySchedules/ezGetDeliveryNos.jsp"); 
		
	String display_header 	= "Dispatch Confirmation";
	String noDataStatement 	= "Dispatch information has been saved successfully.";
