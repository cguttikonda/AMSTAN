...
<%
    	...
    	String prdCodeTemp = prdCode;
    	if(prdCode!=null)
    	prdCode = prdCode.replaceAll("@@@","#");  
    	
    	String vctemp =vendCatalog + " AND EMM_ID = '"+matId+"'"; 
	...
	searchParams.setCatalogCode(vctemp); 
...
<script>
         function funChange(key)
         {
             var prdCode='<%=prdCodeTemp%>'
             var vendCatalog='<%=vendCatalog%>'
             var matId      ='<%=matId%>' 
             attach=window.open("../Uploads/ezBulkImageAttach.jsp?type="+key+"&prdCode="+prdCode+"&vendCatalog="+vendCatalog+"&matId="+matId,"UserWindow1","width=350,height=450,left=300,top=100,resizable=yes,scrollbars=yes,toolbar=no,menubar=no");
...
<body scroll="no">
<form name="myForm">
<input type="hidden" name="prdCode" value="<%=prdCodeTemp%>"> 
...
<input type="hidden" name="matId" value="<%=matId%>">  
	...
	<tr>  
	     <th width="10%" align="left">Material</th>
	     <td width="20%" align="left" colspan=2><%=matDesc%>(<%=matNo%>)&nbsp; </td>	
	</tr> 
	<tr>  
	     <th width="10%" align="left">Image Path</th>
	     <td width="10%" align="left"><%=imgPath%>&nbsp;</td> 
	     <td width="10%"><a href="Javascript:funChange('I')" >Change</a> </td>
	</tr> 
	<tr>  
	     <th width="10%" align="left">Specification1</th>
	     <td width="10%" align="left"><%=spec1%>&nbsp;</td>	
	     <td width="10%"><a href="Javascript:funChange('S1')" >Change</a> </td>
	</tr> 
	<tr>  
	     <th width="10%" align="left">Specification2</th>
	     <td width="10%" align="left"><%=spec2%>&nbsp;</td>	
	     <td width="10%"><a href="Javascript:funChange('S2')" >Change</a> </td>
	</tr>
	<tr>  
	     <th width="10%" align="left">Specification3</th>
	     <td width="10%" align="left"><%=spec3%>&nbsp;</td>
	     <td width="10%"><a href="Javascript:funChange('S3')">Change</a> </td>
	</tr> 
	<tr>  
	     <th width="10%" align="left">Specification4</th>
	     <td width="10%" align="left"><%=spec4%>&nbsp;</td>	
	     <td width="10%"><a href="Javascript:funChange('S4')">Change</a> </td>
	</tr> 
