...
<%@ include file="../../../Includes/JSPs/DrillDownCatalog/iViewPCDetails.jsp"%>  
...
function openDetails(prodID,imagePath)
{
	...
	var ret = window.showModalDialog("../Cnet/ezCnetProdDetails.jsp?prodID="+prodID+"&imagePath="+imagePath,argsVariable,"dialogWidth:600px; dialogHeight:500px; center:yes");
}
function selectAll()
{
...
<%
	if(rSet!=null){
		...
		if("Y".equals(isCatUser))
			widthTab = 40;
%>
<%@ include file="../Cnet/ezGetPCCnetImages.jsp" %>
<%@ include file="../Cnet/ezGetPCCnetPrice.jsp" %>  
...
%>
			...
			<display:column title="Add to Cart" style="width:15%;height:50;text-align:left;cursor:hand"><image src="/CRI/img/addCart.JPG" title="Click here to Add To Cart" onClick="addToCart('<%=rowNum%>','<%=type%>')"/>
