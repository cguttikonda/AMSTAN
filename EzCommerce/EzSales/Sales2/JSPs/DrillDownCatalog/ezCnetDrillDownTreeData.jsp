...
<%@ include file="../../../Includes/JSPs/DrillDownCatalog/iFullCnetCatalog.jsp"%> 
<%
	...
	if("0".equals(id))
	{
	      if(!"Y".equals(addProduct) && !"Y".equals(isCatUser))
	      {
			 ...
			 for(int i=0;i<retPerCat.getRowCount();i++)
			 {
			    ...
			    if((perCatDescT==null)||(perCatDescT=="null")||(perCatDescT.trim().length() == 0))
			    {
				perCatDescT ="N/A";
			    }
			    if((catType==null)||(catType=="null")||(catType.trim().length() == 0))
			    {
				catType ="N/A";
			    }
	      ...
	      out.println("<item child='0' id='VC' text='All Categories' select='yes'>");
		...
		{    
		    ...
		    String venCatDescT="";
		    java.util.Collections.sort(hashValVect);
