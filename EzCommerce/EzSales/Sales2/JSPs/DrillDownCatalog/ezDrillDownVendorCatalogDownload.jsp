...
<frameset cols="22%,*" rows="*" border="0" framespacing="0"  marginheight=0 margintop=0> 
	<frame src="ezVendorDrillDownTreeDownload.jsp?addProduct=Y" name="options" marginwidth="0"  marginheight=0 margintop=0 scrolling="NO" frameborder="NO">	
	<frame src="ezDrillDownDisplayDownload.jsp" name="subDisplay" marginwidth="0"  marginheight=0 margintop=0 scrolling="NO" frameborder="NO">	
