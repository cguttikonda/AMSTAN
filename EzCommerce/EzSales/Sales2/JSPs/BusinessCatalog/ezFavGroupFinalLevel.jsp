...
%>
		...
		<Table width="70%" id="tabHead"  align=center border=1 borderColorDark=#ffffff borderColorLight=#006666 cellPadding=2 cellSpacing=0 >
			<Tr>
				...
				<th width="15%" align="center">Brand</th>
...
<%
		...
		for ( int i = 0 ; i <  retCount; i++ )
		{
			...
			if(matDetails.containsKey(prodNum))
			{
				matSt = (String)matDetails.get(prodNum);
				try
				{
					st = new java.util.StringTokenizer(matSt,"@@@");
      
					if(st!=null)
					{
						manNum	= st.nextToken(); 	
						manName	= st.nextToken();
						stock	= st.nextToken();
						matFlg  = st.nextToken();
						// ezc.ezcommon.EzLog4j.log("manNum>>:"+manNum+" stock>>:"+stock,"I");
					}
				}
				catch(Exception e)
				{
					ezc.ezcommon.EzLog4j.log("Exception Occured while taking StringTokenizer:"+e,"W");
				}
			}
...
%>
			  ...
			  <TD width="15%" align="center"><%= ret.getFieldValueString(i,"EMM_MANUFACTURER") %></Td>
