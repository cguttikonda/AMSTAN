...
function showCal(fieldName,dTop,dLeft,CD,CM,CY)  
{
	...
	if(eval(calShowFlag))
	{
		...
		if(showFlag)   	
		{
			...
			text +="<Table border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=2 cellSpacing=0 align=left class='caltable' width='" + CellTableWidth + "'><Tr><Td align=center class='caltd' width=100%>"
