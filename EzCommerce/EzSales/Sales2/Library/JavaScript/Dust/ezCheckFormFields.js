...
FieldName[1] = "companyid";
CheckType[1] = "MNULL";
Messages[1] = "Please Enter Your Company Name";



FieldName[2] = "city";
CheckType[2] = "MNULL";
Messages[2] = "Please Enter City";

FieldName[3] = "state";
CheckType[3] = "MNULL";
Messages[3] = "Please Enter State";


FieldName[4] = "zipcode";
CheckType[4] = "MNULL";
Messages[4] = "Please Enter Valid ZipCode";

FieldName[5] = "email";
CheckType[5] = "MEMAIL";
Messages[5] = "Please Enter Valid E-Mail";

FieldName[6] = "tel";
CheckType[6] = "MNUMBER";
Messages[6] = "Please Enter Valid Telephone Number";
...
function chk()
{
	var s=  funCheckFormFields(document.form1,FieldName,CheckType,Messages);
	return s; 
}
...
{	var s=""
	...
	if (atPos == -1)
	{
		msgString = "You need to provide your Email Id. i.e  your email should be in this format info@site.com ."
		return false;
	}
...
function comparePassword(p,c)
{
   if(p.length<5)
   {  
       
       alert("Password Should not be lessthan Five Numbers"); 
       return false
   }
   else
   {
...
function compareEmail(e1,e2)
{
          ...
          {
           alert("EMail and EMail Verification Should be Same");
           return false
          }
}      
