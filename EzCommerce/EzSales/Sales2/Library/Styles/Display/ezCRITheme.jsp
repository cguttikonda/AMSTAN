...
body {
	...
	background-color: #FFFFFF;
	overflow-y : scroll;
	scrollbar-3dlight-color:#116FAF;
	scrollbar-arrow-color:#02335E;
	scrollbar-base-color:#116FAF;
	scrollbar-darkshadow-color:#116FAF;
...
color: white;
background: #116FAF url(media/arrowstop.gif) no-repeat 8px 6px; /*last 2 values are the x and y coordinates of bullet image*/
