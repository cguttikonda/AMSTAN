...
<%!
	public String getButtonStr(java.util.ArrayList buttonName,java.util.ArrayList buttonMethod)
	{
		...
		sb.append("<table border=0 cellspacing=0 cellpadding=0 class=buttonTable><tr border=0>");
...
%>
<link type="text/css" rel="stylesheet" href="../../Library/Styles/Display/ez<%=ButtonDir%>Theme.css">
