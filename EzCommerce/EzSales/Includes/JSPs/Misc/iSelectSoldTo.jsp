...
//final String ERP_CUST_NUM = "ECA_NO";
...
<%
	...
	ezc.ezutil.EzSystem.out.println("Hi i am after getUserCatalogAreas()---->"+retcatarea);
	ezc.ezutil.EzSystem.out.println("The Catalog_Area is --->"+catalog_area);

	catalog_area =(catalog_area == null)?retcatarea.getFieldValueString(0,SYSTEM_KEY):catalog_area;
	catalog_area.trim();
	ezc.ezutil.EzSystem.out.println("Catalog Area -- " + catalog_area);
	...
	ezc.ezutil.EzSystem.out.println("I am after getUserCustomers()"+retsoldto);
	if(retcatarea != null)
	...
	if(retsoldto != null)
		...
		soldtoRows =0;
	ezc.ezutil.EzSystem.out.println("Number Of Sold Tos **************----->>>>>>: " + soldtoRows+">>>>"+catareaRows);
