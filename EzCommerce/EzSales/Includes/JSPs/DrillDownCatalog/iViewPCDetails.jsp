<%
	...
	EzcParams ezcpparams = null;
	EzCnetConnectorParams cnetParams = null;
		...
		if(cnetRet!=null && cnetRet.getRowCount()>0)
		{
			...
			if(retObj!=null && retObj.getRowCount()>0)
			{
				for(int k=0;k<retObj.getRowCount();k++)
				{
					...
					gbRet.setFieldValue("EPF_MM_ID",retObj.getFieldValueString(k,"MfID"));
					...
					gbRet.setFieldValue("EMM_ID",retObj.getFieldValueString(k,"MfIDText"));
					gbRet.setFieldValue("EMM_CATALOG_NO",retObj.getFieldValueString(k,"CatID"));
					gbRet.setFieldValue("EMM_NO",retObj.getFieldValueString(k,"ProdID"));
					gbRet.setFieldValue("EMM_MANUFACTURER",retObj.getFieldValueString(k,"MfIDText"));
					...
					gbRet.setFieldValue("EMM_IMAGE_PATH",retObj.getFieldValueString(k,"ImgID"));
					...
					gbRet.setFieldValue("EMM_EAN_UPC_NO",retObj.getFieldValueString(k,"MfPN"));
					...
					gbRet.setFieldValue("EMD_DESC",retObj.getFieldValueString(k,"ProdIDDesc"));
