...
<%@ include file="../../../Includes/JSPs/Rfq/iSearchMaterial.jsp"%>
<html>
<head>
<base target="_self">
...
<Script>
	function selectMaterials()
	{
		...
		opener.window.document.myForm.matDescScrh.value = "";
		window.close();
	}
	function closeWin()
	{
...
<%
		...
		{
			matCode = retMaterialsList.getFieldValueString(i,"MATNR").trim();
