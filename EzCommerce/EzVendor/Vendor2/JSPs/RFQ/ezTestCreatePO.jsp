...
<%
	...
	String        collNo 	 = "6000000052";//request.getParameter("collectiveRFQNo");
	String[]      rfqNumbers = {"6000000052"};//request.getParameterValues("rfqNumbers");
	...
	for(int i=0;i<myRetCount;i++)
	{
		...
		headerParams.setVendor("S-1006");		//vendor[i]	//"1100000887"
		headerParams.setDocType("NB");		//docType[i]	//"ZRMI"
