...
<script>
   ...
   function setMessageLocal(i)
   {
		var divVal = document.getElementById("ButtonDiv"+i);
...
<body topmargin=0 rightmargin=0 leftmargin=0 onLoad="showDiv_new('1','4');setDefaults()" scroll="no">
...
<!-- <table align="center" width="40%" border=1 borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=2 cellSpacing=0>
 ...
 <div id="totDiv"> <!--  id="totDiv" style="position:absolute;top:6%;width:100%;height:100%">  //commented by suresh -->
...
<div align=center style="overflow:auto;position:absolute;height:75%;width:96%;left:3%;top:0%;background-color:'#E6E6E6'">
<br/><br/>
...
<tr><td class="blankcell">
	...
	<Tr>
	<th width="14%" align="left"><%=zip_L%></th>
        <td width="35%"><%=zipcode%>&nbsp;</td>
	<th width="14%" align="left"><%=phone_L%>2 </th>
        <td width="35%">
	...
	<Tr>
	<th width="14%" align="left"><%=country_L%></th>
	<td width="35%"><%=country%>&nbsp;</td>
	<th width="14%" align="left"><%=email_L%></th>
        <td width="35%">
    ...
    <Tr>
    <Td class="blankcell" style="background-color:'#E6E6E6'"><%=ifChCadd_L%><a href="../Misc/ezGetInfo.jsp"><%=chAdd_L%></a> .</Td>
    </Tr>
</table>

	</div>

<div id="ButtonDiv1" align=center style="position:absolute;top:85%;width:100%">
...
<div align=center style="overflow:auto;position:absolute;height:75%;width:96%;left:3%;background-color:'#E6E6E6'">
<br/><br/>
<table align=center width=85% border=0 borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=0 cellSpacing=0>
<tr><td class="blankcell">
...
<div id="ButtonDiv2" align=center style="position:absolute;top:85%;width:100%">
<!-- <a href="../Misc/ezSBUWelcome.jsp" target="display"><img src="../../Images/Buttons/<%=ButtonDir%>/back.gif" style="cursor:hand" border="none"></a>
<img src="../../Images/Buttons/<%=ButtonDir%>/adddocuments.gif" style="cursor:hand" border="none" valign=bottom onClick="openUploadWindow()"> -->
<%
...
<div id="ButtonDiv3" align=center style="position:absolute;top:85%;width:100%">
...
<tr><td class="blankcell">
 ...
 <table align=center border=1 borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=2 cellSpacing=0 width="100%">
		<tr>
	    <th width="35%"align="left"><%=organogram_L%></th>
	...
	<tr>
            ...
            <th width="35%" align="left"><%=bankerDet_L%> </th>
            ...
            <th width="35%" align=left><%=productsOffered_L%></th>
		...
		<tr>
           ...
           <th width="35%" align=left><%=newDevelopments_L%></th>
...
<div id="ButtonDiv4" align=center style="position:absolute;top:85%;width:100%">
<!-- <a href="../Misc/ezSBUWelcome.jsp" target="display"><img src="../../Images/Buttons/<%=ButtonDir%>/back.gif" style="cursor:hand" border="none"></a>
<img src="../../Images/Buttons/<%=ButtonDir%>/adddocuments.gif" style="cursor:hand" border="none" valign=bottom onClick="openUploadWindow()"> -->
<%
