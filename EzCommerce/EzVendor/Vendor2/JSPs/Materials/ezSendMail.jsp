...
<%
	...
	String sendToUser = "";
	boolean isPropError=false;
	ResourceBundle contacts=null;
	String mailIds=null;
	try{
		contacts= ResourceBundle.getBundle("SBUContacts");
		mailIds=contacts.getString((String)session.getValue("SYSKEY"));
	}
	catch(Exception e)
	{
	    isPropError=true; 
	...
	StringTokenizer stMailIds=null;
	if(! isPropError)
	{
	     stMailIds= new StringTokenizer(mailIds,",");	
	     while(stMailIds.hasMoreTokens())	
	     {
		sendToUser = sendToUser+stMailIds.nextToken()+";";
	     }		
	}
