...
<%
		...
		try
		{
			...
			rs = stmt.executeQuery("SELECT EVRD_ID,EVRD_CREATED_ON,EVRD_STATUS,EVRD_EXT1 FROM EZC_VENDOR_REG_DETAILS WHERE EVRD_STATUS='"+selectedStatus+"'");
...
<%				while(rs.next()) 
				{
					String link = "ezvendordisplay_bkp.jsp?id="+rs.getInt("EVRD_ID");
					...
					else if ("PP".equals(rs.getString("EVRD_STATUS"))) submittedBy = "PURPERSON";
					else if ("PH".equals(rs.getString("EVRD_STATUS"))) submittedBy = "PURHEAD";
%>					
					<Tr>
