...
%>					
				...
				<td align="left" valign=center>
					<input type="text" class=InputBox  name="DCDate"  value="<%=dcdate%>" size=12 readonly onfocus=this.blur()>
					<%//=getDateImage("DCDate")%>
				</td>
 			...
 			<tr>
				...
				<td align="left" valign=center>
					<input type="text" class=InputBox  name="InvoiceDate"  value="<%=invdate%>" size=12 readonly onfocus=this.blur()>
			...
			<tr>
				...
				<td align="left" valign=center><input type="text" class=InputBox  name="ShipDate"  value="<%=shipdate%>" size=12 readonly onfocus=this.blur()>
			...
			<tr>
				...
				<Td valign=center><input type="text" class=InputBox  value="<%=expTime%>" name="ExpectedArivalTime"  size=12 readonly onfocus=this.blur()>
