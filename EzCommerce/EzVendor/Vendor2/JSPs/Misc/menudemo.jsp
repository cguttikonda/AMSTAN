...
<Frameset rows="60,*,5%" cols="*" framespacing="0" frameborder="No" border=no scrolling="yes">
...
<Frame  name="footer" src="../jquerys/menuFrame.jsp"  border=no scrolling=no noresize>
