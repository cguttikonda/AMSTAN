...
%>
<title>Logout--Powered by Answerthink</title>
...
%>
					...
					browser doesn't support the refresh tag click <b><a href="/">here</a></b>
...
<%
				...
				{
%>
					<font size="2" face="tahoma"><b>Maximum idle time exceeded...Logging out automatically<BR><BR>Click <a href='/'>here</a> to login again</b></font>
<%
				}
%>
