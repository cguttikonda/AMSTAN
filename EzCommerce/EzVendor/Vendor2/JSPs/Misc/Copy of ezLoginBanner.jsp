...
<TR>
<TD width=15% valign=top bgcolor="#CC0000">
	<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
	<TR >
		<TD>
...
<TD valign=top background='../../../../EzCommon/Images/Banner/banner_ext.jpg'>
...
<%		
			for ( int i = 0 ; i < catareaRows; i++ )
			{
				...
				if(purGroupArea.equals(purchaseArea))
				{
					...
					selected = "";
%>
				<option <%=selected%> value="<%=purGroupArea%>"><%=purGroupCode%> ---> <%=purGroupDesc%></option>
<%			
			}
%>
			</select>
