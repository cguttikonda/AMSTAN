...
.footer
{
	   filter:progid:DXImageTransform.Microsoft.Gradient(GradientType=0,StartColorStr='#FFFFFF',EndColorStr='#A1B4BF');
}
.footer1
{
...
<Tr >
<Td class=footer height=5%>&nbsp;</Td>
</Tr>
<TR>
<TD align=center>
	 <img src="../../../../EzCommon/Images/Banner/banner_ext1.jpg" width=100% >
	<!--<img src="../../../../EzCommon/Images/Banner/footer.jpeg" width=100% > -->
</TD>	
</TR>	
</TABLE>
</Div>
...
<Tr>
	...
	<Td width=35% align=right>
		<Div id='LiveClock' class=footerpowerby></Div>
	</Td>
</Tr>
<Tr>
