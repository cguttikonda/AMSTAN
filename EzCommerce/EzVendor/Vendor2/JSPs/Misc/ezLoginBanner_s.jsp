...
<Head>
	...
	function changePurArea1()
	{
		if(confirm("Do you want to continue with the selected Purchase Area?"))
		{
			...
			document.myForm.action = "ezLoginBanner_s.jsp?CatalogArea="+selcatarea;
...
<a href="../Misc/ezSBUWelcomeWait.jsp" target="right"><IMG src="../../../../EzCommon/Images/Banner/logo_top.jpg" border=0></a>			
			
		
</TD>

	<TD width="95%" valign=top background='../../../../EzCommon/Images/Banner/top_sa.jpg'>
		<Table align=right  width="100%" height=100% border="0" cellspacing="0" cellpadding="5">
		<Tr>
			<Td align=center valign=top >
				<Font color='#23251A' size=2  face="Tahoma"> <b> Welcome <i><%=fullName%></i> to Procurement Portal</b>
			</Td>
			<Td valign=top align=right>
				<Font color='#23251A' size=2  face="Tahoma">
					
					
					<img src="../../../../EzCommon/Images/Banner/ic_logout.gif" border=no title='Logout' style="cursor:hand"><a  href="javascript:callFun('L')"><font color='23251A'>Logout</font></a>
					&nbsp;
				</Font>
			</Td>	
		</Tr>  
