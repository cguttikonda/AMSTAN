...
<%
	...
	String sendToUser = "rangark@drreddys.com;srinivasbv@drreddys.com;vramdas@drreddys.com;vkarumudi@ezcommerceinc.com";
	String msgSubject=request.getParameter("msgSubject");
	String msgText=request.getParameter("msgText");

	String vendor = (String)session.getValue("Vendor");	
...
<%
	response.sendRedirect("../Shipment/ezMessage.jsp?Msg=Thank you for entering your Comments");
%>
<Div id="MenuSol"></Div>
