...
<style type="text/css" media="screen">
	...
	#example thead th:last-child { border-right: 1px solid #AAA; } </style> 
<script src="http://code.jquery.com/jquery-latest.js"></script>
<script type="text/javascript" src="../../Library/JavaScript/complete.min.js"></script>
<script type="text/javascript" src="../../Library/JavaScript/jquery.dataTables.min.js"></script> 

<script  src="../../Library/JavaScript/colResizable-1.3.min.js"></script>
