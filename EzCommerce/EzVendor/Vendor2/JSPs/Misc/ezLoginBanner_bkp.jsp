...
<Head>
	...
	function changePurArea1()
	{
		if(confirm("Do you want to continue with the selected Purchase Area?"))
		{
			...
			document.myForm.action = "ezLoginBanner_bkp.jsp?CatalogArea="+selcatarea;
	...
	function changeVendor(mFlag)
	{
		...
		if(mFlag == 'Y')
		{
			...
			document.myForm.target="banner"
			document.myForm.action="ezLoginBanner_bkp.jsp";
			document.myForm.submit();
		}
		else
		{
...
<TR width="100%">
<!--<TD width="5%" valign=top bgcolor="#D52B1E">-->
<TD width="5%" valign=top bgcolor="#0C517B">
	
			<!--<IMG src="http://www.mtrfoods.com/images/logo.png" height=75 width=65>-->
			<IMG src="../../../../EzCommon/Images/Banner/ezc_logof.jpg" border=0>
...
<TD width="95%" valign=top bgcolor="#0C517B">
<!--<TD width="95%" valign=top background='../../../../EzCommon/Images/Banner/banner_ext1.jpg'>-->
	...
	<Tr>
		...
		<Td valign=top align=right>
			<Font color='#FFFFFF' size=2  face="Tahoma">
				<span id='home_mail'>
					<img src="../../../../EzCommon/Images/Banner/ic_home.gif" border=0><a href="javascript:callFun('H')">home</a>
					&nbsp;
					<img src="../../../../EzCommon/Images/Banner/ic_mail.gif" border=no title='Check Mails' style="cursor:hand"><a  href='../Inbox/ezListPersMsgs.jsp' target="display">mails</a>
					&nbsp;
				</span>
				<img src="../../../../EzCommon/Images/Banner/ic_support.gif" border=no title='Contact for any support' style="cursor:hand"><a  href='mailto:<%=XMLsupportid%>'>support</a>
				&nbsp;
