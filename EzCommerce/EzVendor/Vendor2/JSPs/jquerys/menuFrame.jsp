...
//document.write('' +'Browser name  = '+browserName+'<br>')
			...
			close_img = new Image();
			close_img.src="back.jpg";

			open_img = new Image();
			open_img.src="front.jpg";
	...
	<body onLoad="onLoad()">
		<table height=100% >
			<tr>
			<td id='tdTree'>
				<IFrame id="treeFrame" name="treeTab" src="Menu.jsp" width='100%' height='100%' frameborder=0 scrolling="yes"></IFrame>
				</td>
			<td id='tdDiv' >
				<a href='JavaScript:resizeFrame()'><img id="img_id" src="back.jpg"></a>
			</td>
			<td id='tdGrid'>
				<IFrame id="gridFrame" name="right" src="sam.jsp" width='100%' height='100%' frameborder=0 scrolling="no"></IFrame>
			</td>
			</tr>
		</table>
	</body>
