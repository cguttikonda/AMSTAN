...
function search(index)
{
	...
	var url="../PRs/ezMatSearchOptions.jsp?myIndex="+index+"&selPlant="+selPlant+"&SAP=Y";
...
{ 
	...
	document.myForm.action="JCOCreateSTO.jsp";
...
<%
	String display_header = "Create Stock Transfer Order";
...
<Table align=center id="ezRCItemTab"  border=0 borderColorDark=#ffffff borderColorLight=#006666 cellPadding=1 cellSpacing=1 width='95%'>
	<Tr>
		<Th width="10%" height="10" align="center">Item No</Th>
		...
		<Th width="10%" height="10" align='center'>Supplying Plant</Th>
		<Th width="10%" height="10" align='center'>Receiving Plant</Th>
	</Tr> 
<%
	for(int m=0;m<1;m++)
	{
...
%>
	<Tr>
		<Td width="10%" align="center">
			<input type="text" name="itemNumber" class="tx" readonly size="5" value="<%=lineItemNo%>">
		...
		<Td width="10%" align="center"><input type="text" name="poQty" class="InputBox" size="12" maxlength="7" value="" onBlur=checkNumeric(this,"QTY")></Td>
		
		<Td width="10%" align="center">
			<Select name="suppPlant">
			<Option value ="BP01">BP01</Option>
			<Option value ="BP02">BP02</Option>
		</Td>
		
		<Td width="10%" align="center">
			<Select name="recPlant">
			<Option value ="BP01">BP01</Option>
			<Option value ="BP02" selected>BP02</Option>
		</Td>
