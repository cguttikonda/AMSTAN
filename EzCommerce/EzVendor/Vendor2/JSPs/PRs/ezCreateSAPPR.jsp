...
<%
	...
	String[] itemNumbers = request.getParameterValues("tItemNumber");
	String sapReqNumber=null,dispMessage="";
	boolean errorFlag = false;

	int noOfRows = itemNumbers.length;
	int itemNumber = 1;

	for(int i = 0; i < noOfRows; i++)
	{
		
		String material = request.getParameter("matNumber"+i);
		if(material!=null && !"".equals(material.trim()))
		{
		
			
			String matDesc = request.getParameter("matDesc"+i);
			String plant = "BP01";
			String quantity = request.getParameter("prQty"+i);
			String valPrice = request.getParameter("valPrice"+i);
			String uom = request.getParameter("prUOM"+i);
			String purGrp = "";
			...
			try{
				String ddate = request.getParameter("delvDate"+i);
			...
			if(matDesc != null && !"".equals(matDesc))
			    itemsTable.setValue(matDesc, "SHORT_TEXT");
