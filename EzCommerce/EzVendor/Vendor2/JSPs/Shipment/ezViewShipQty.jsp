...
%>
	...
	var batches=values[3].split("!!!");
	var sfiles=args[1].split("!!!");
	var matcode='';
	if(values.length==4)
		matcode = values[3]
	...
	document.write("<table border='1' borderColorDark=#ffffff borderColorLight=#000000 cellPadding=2 cellSpacing=0 align='center' width='100%'><tr><th width='20%'><%=batch_no_L%></th><th width='20%'><%=mfg_date_L%></th><th width='20%'>Expire Date</th><th width='10%'><%=batch_qty_L%></th><th width='20%'><%=coa_doc_L%></th></tr>");
