...
<Script>
	...
	function submitIt1()
	{
		...
		else
		{
			...
			document.myForm.action  = "ezSavedShipments.jsp" ;
...
<%	
	...
	if(rowCount >= 0)
	{
		String display_header = "View Saved Shipment";
		String selected = "";
%>
...
<%
			...
			{
				if(!finalret.getFieldValueString(i,"STATUS").equals("N"))
					continue;
...
%>
				...
				<td width="15%" align="center">
					...
					<%//out.print("::"+finalret.getFieldValueString(i,"STATUS"));%>
					<a href="JavaScript:funDetails(<%=i%>,'<%=finalret.getFieldValueString(i,"STATUS")%>')"  onMouseover="window.status='Click to edit the Shipment Details '; return true" onMouseout="window.status=' '; return true">Edit</a>
				</td>
				</tr>
<%
			}
