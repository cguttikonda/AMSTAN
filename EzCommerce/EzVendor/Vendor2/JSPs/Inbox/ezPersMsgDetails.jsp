...
<%@ include file="../../../Includes/JSPs/Labels/iPersMsgDetails_Labels.jsp"%>
<%@ include file="../../../Includes/Lib/InboxBean.jsp"%>
<%@ include file="../../../Includes/Lib/Inbox.jsp"%>
<%@ include file="../../../Includes/Lib/AddButtonDir.jsp"%>
<%@ page import="java.util.*,java.text.*,ezc.ezutil.*" %>
...
<%
	...
	EzMessageParams ezMessageParams = new EzMessageParams();
		...
		String finalname=firstname+" "+middlename+" "+lastname;
	     	...
	     	String msgDate = FormatDate.getStringFromDate((Date)retMsgInfo.getFieldValue(0, MSG_CREATED_DATE),(String)session.getValue("DATESEPERATOR"),Integer.parseInt((String)session.getValue("DATEFORMAT")))+"&nbsp;&nbsp;"+retMsgInfo.getFieldValue(0, "EPM_CREATION_TIME");
	     	if(msgDate == null)
	     	{msgDate="";}
...
%>
		...
		<Tr  valign="middle" >
                <Td height="40" style="WORD-BREAK:BREAK-ALL"><!--<Textarea title="Type Message Text" style="overflow:auto;width:100%" tabIndex=5 name="msgText" rows=5> <%=msgContent%></Textarea>-->
                <%=msgContent%>
                </td><tr></table>
...
%>
		<Table  width="95%" align=center border=0 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=2 cellSpacing=0 >
		<Tr  valign="middle" >
<Td  height="40" style="WORD-BREAK:BREAK-ALL"><!--<Textarea title="Type Message Text" style="overflow:auto;width:100%" tabIndex=5 name="msgText" rows=5 readonly> <%=msgContent%></Textarea>-->
	<%=msgContent%>
</td><tr></table>
