<%
	...
	timeStampParams.setSoldTo(defErpVendor);
	sParams.setObject(timeStampParams);
	Session.prepareParams(sParams);
	System.out.println("DESTEP1111111111111111"+defErpVendor);
	ReturnObjFromRetrieve retDate=(ReturnObjFromRetrieve)AppManager.ezGetVendorTimeStamp(sParams);
	System.out.println("DESTEP2222222222222222");
	if(retDate.getRowCount()>0)
	{
		...
		//FromDate=new java.sql.Date(106,1,1);
	...
	else
	{
		...
		addtimeStampParams.setSoldTo(defErpVendor);
