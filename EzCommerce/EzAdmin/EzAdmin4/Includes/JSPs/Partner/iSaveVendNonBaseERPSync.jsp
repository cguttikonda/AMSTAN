...
String EzcSoldTo = null;
String pEzcSoldTo = null;
...
for ( int i = 0  ; i < TotalCount; i++ ){
	...
	EzcSoldTo = "Ezc_SoldTo_"+i;
	pEzcSoldTo = request.getParameter(EzcSoldTo);
	...
	for ( int j = 0  ; j < intBPCount; j++ ){
		...
		custin.setCustomerNo(pEzcSoldTo);	
...
VendorManager.SaveEzcCustomerAddr(vparams1); 
			//VendorManager.SaveEzcCustomerAddr(servlet, in); 
		}//End if checkbox
	}//End for AddCount
...
response.sendRedirect("../Partner/ezVendNonBaseERPSync.jsp");
