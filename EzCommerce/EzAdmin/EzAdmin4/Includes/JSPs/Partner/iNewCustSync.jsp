...
String soldToToBeReSync = request.getParameter("SysKey");

//out.println("soldToToBeReSync::::"+soldToToBeReSync);
//out.println("BusinessPartner::::"+request.getParameter("BusinessPartner"));

if(soldToToBeReSync!=null && !"null".equals(soldToToBeReSync) && !"".equals(soldToToBeReSync) && soldToToBeReSync.length()>10)
{														
	soldToToBeReSync = soldToToBeReSync.substring(7,17); 				
}
//out.println("soldToToBeReSync::::"+soldToToBeReSync);
