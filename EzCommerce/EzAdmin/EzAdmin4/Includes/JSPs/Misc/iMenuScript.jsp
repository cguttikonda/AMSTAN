...
EZ_ADMIN1 = [
	...
	EZ_ADMIN1_6 = [
			["List","../Config/ezListBusAreas.jsp?Area=V",0,1,"No"],
			["Add","../Config/ezAddBusAreaDesc.jsp?Area=V",0,1,"No"],
			["Modify","../Config/ezUpdateBusAreas.jsp?Area=V",0,1,"No"],
			["Defaults","../Config/ezSetBusAreaDefaults.jsp?Area=V",0,1,"No"],
			["By Defaults","../Config/ezListBusAreasByDefaults.jsp?Area=V",0,1,"No"],
			["With Defaults","../Config/ezListAllAreasWithDefaults.jsp?Area=AV",0,1,"No"]

		]

/*	EZ_ADMIN1_7 = [
			["List","../Config/ezListBusAreas.jsp?Area=S",0,1,"No"],
			["Add","../Config/ezAddBusAreaDesc.jsp?Area=S",0,1,"No"],
			["Modify","../Config/ezUpdateBusAreas.jsp?Area=S",0,1,"No"],
			["Defaults","../Config/ezSetBusAreaDefaults.jsp?Area=S",0,1,"No"]
		]
*/
	EZ_ADMIN1_7 = [
	...
	/*
	EZ_ADMIN2_1 = [
			["By User Id","../WorkFlow/ezGetUserHierarchy.jsp?userType=USER",0,1,"No"],
			["By Sold To","../WorkFlow/ezGetUserHierarchy.jsp?userType=SOLDTO",0,1,"No"]
			]		
	*/
	EZ_ADMIN2_1 = [
	...
	/*EZ_ADMIN2_1 = [
			["Graph1","../WorkFlow/ezPreGraph.jsp?NO=1",0,1,"No"],
			["Graph2","../WorkFlow/ezPreGraph.jsp?NO=2",0,1,"No"],
			["Graph3","../WorkFlow/ezPreGraph.jsp?NO=3",0,1,"No"]
			//["Graph4","../WorkFlow/ezPreGraph.jsp?NO=4",0,1,"No"]
		]
*/
	EZ_ADMIN3 = [
			...
			["Catalog Description","../Catalog/ezCatalogName.jsp",0,1,"No"],
	...
	/*
	EZ_ADMIN4_5 = [
			["Vendor","../Partner/ezDeleteSynchListBPBySysKey.jsp?Area=V&FUNCTION=VN",0,1,"No"],
			["Customer","../Partner/ezDeleteSynchListBPBySysKey.jsp?Area=C&FUNCTION=AG",0,1,"No"]
		]
	*/
	EZ_ADMIN4_5 = [
	...
	EZ_ADMIN4_6_1 = [
			["By Partner Name","../Partner/ezSearchBPBySysKey.jsp?Area=V",0,1,"No"],
			["By ERP Vendor","../Partner/ezSearchBPBySoldTo.jsp?Area=V",0,1,"No"],
			["By Partner Function","../Partner/ezSearchPartnerByPartnerFunction.jsp?Area=V",0,1,"No"]
	]
	EZ_ADMIN4_6_2 = [
...
/*
	For Partner Filtering By Partner Type
		EZ_ADMIN4_1 = [
				["Vendor Partners","",1,1,"No"],
				["Sales Partners","",1,1,"No"]
			]
		...
		EZ_ADMIN4_1_1 = [
				["Business","../Partner/ezAuthListBPBySysKey.jsp?Area=V&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezAuthListBPBySysKey.jsp?Area=V&myUserType=2",0,1,"No"],
				["All","../Partner/ezAuthListBPBySysKey.jsp?Area=V",0,1,"No"]
			]
		EZ_ADMIN4_1_2 = [
				["Business","../Partner/ezAuthListBPBySysKey.jsp?Area=C&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezAuthListBPBySysKey.jsp?Area=C&myUserType=2",0,1,"No"],
				["All","../Partner/ezAuthListBPBySysKey.jsp?Area=C",0,1,"No"]
			]
		...
		EZ_ADMIN4_2_1 = [
				["Business","../Partner/ezSynchListBPBySysKey.jsp?Area=V&FUNCTION=VN&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezSynchListBPBySysKey.jsp?Area=V&FUNCTION=VN&myUserType=2",0,1,"No"],
				["All","../Partner/ezSynchListBPBySysKey.jsp?Area=V&FUNCTION=VN",0,1,"No"]
			]
		EZ_ADMIN4_2_2 = [
				["Business","../Partner/ezSynchListBPBySysKey.jsp?Area=C&FUNCTION=AG&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezSynchListBPBySysKey.jsp?Area=C&FUNCTION=AG&myUserType=2",0,1,"No"],
				["All","../Partner/ezSynchListBPBySysKey.jsp?Area=C&FUNCTION=AG",0,1,"No"]
			]
		...
		EZ_ADMIN4_3_1 = [
				["Business","../Partner/ezDefaultsListBPBySysKey.jsp?Area=V&FUNCTION=VN&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezDefaultsListBPBySysKey.jsp?Area=V&FUNCTION=VN&myUserType=2",0,1,"No"],
				["All","../Partner/ezDefaultsListBPBySysKey.jsp?Area=V&FUNCTION=VN",0,1,"No"]
			]
		EZ_ADMIN4_3_2 = [
				["Business","../Partner/ezDefaultsListBPBySysKey.jsp?Area=C&FUNCTION=AG&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezDefaultsListBPBySysKey.jsp?Area=C&FUNCTION=AG&myUserType=2",0,1,"No"],
				["All","../Partner/ezDefaultsListBPBySysKey.jsp?Area=C&FUNCTION=AG",0,1,"No"]
			]
		...
		EZ_ADMIN4_4_1 = [
				["Business","../Partner/ezListBPBySysKey.jsp?Area=V&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezListBPBySysKey.jsp?Area=V&myUserType=2",0,1,"No"],
				["All","../Partner/ezListBPBySysKey.jsp?Area=V",0,1,"No"]
			]
		EZ_ADMIN4_4_2 = [
				["Business","../Partner/ezListBPBySysKey.jsp?Area=C&myUserType=2",0,1,"No"],
				["Internal","../Partner/ezListBPBySysKey.jsp?Area=C&myUserType=2",0,1,"No"],
				["All","../Partner/ezListBPBySysKey.jsp?Area=C",0,1,"No"]
			]
		...
		EZ_ADMIN4_5_1 = [
				["Business","../Partner/ezDeleteSynchListBPBySysKey.jsp?Area=V&FUNCTION=VN&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezDeleteSynchListBPBySysKey.jsp?Area=V&FUNCTION=VN&myUserType=2",0,1,"No"],
				["All","../Partner/ezDeleteSynchListBPBySysKey.jsp?Area=V&FUNCTION=VN",0,1,"No"]
			]
		EZ_ADMIN4_5_2 = [
				["Business","../Partner/ezDeleteSynchListBPBySysKey.jsp?Area=C&FUNCTION=AG&myUserType=3",0,1,"No"],
				["Internal","../Partner/ezDeleteSynchListBPBySysKey.jsp?Area=C&FUNCTION=AG&myUserType=2",0,1,"No"],
				["All","../Partner/ezDeleteSynchListBPBySysKey.jsp?Area=C&FUNCTION=AG",0,1,"No"]
		]
*/

/*
	EZ_ADMIN4_6 = [
			["Vendor","../Partner/ezSummaryListBPBySysKey.jsp?Area=V&FUNCTION=VN",0,1,"No"],
			["Customer","../Partner/ezSummaryListBPBySysKey.jsp?Area=C&FUNCTION=AG",0,1,"No"],
			["All","../Partner/ezBPSummary.jsp",0,1,"No"]
		]
*/
	...
	EZ_ADMIN5_2_1 = [
			["Business Users","../User/ezAuthListAllUsersBySysKey.jsp?Area=V&myUserType=3",0,1,"No"],
			["Internal Users","../User/ezAuthListAllUsersBySysKey.jsp?Area=V&myUserType=2",0,1,"No"],
			["All Users","../User/ezAuthListAllUsersBySysKey.jsp?Area=V",0,1,"No"]
		]
	EZ_ADMIN5_2_2 = [
	...
	EZ_ADMIN5_3_1 = [
			["Business Users","../User/ezDefaultsListAllUsersBySysKey.jsp?Area=V&myUserType=3",0,1,"No"],
			["Internal Users","../User/ezDefaultsListAllUsersBySysKey.jsp?Area=V&myUserType=2",0,1,"No"],
			["All Users","../User/ezDefaultsListAllUsersBySysKey.jsp?Area=V",0,1,"No"]
		]
	EZ_ADMIN5_3_2 = [
	...
	EZ_ADMIN5_4_1 = [
			["Business Users","../User/ezListAllUsersBySysKey.jsp?Area=V&myUserType=3",0,1,"No"],
			["Internal Users","../User/ezListAllUsersBySysKey.jsp?Area=V&myUserType=2",0,1,"No"],
			["All Users","../User/ezListAllUsersBySysKey.jsp?Area=V",0,1,"No"]
		]
	EZ_ADMIN5_4_2 = [
...
/*
	...
	EZ_ADMIN5_4 = [
			["Vendor Users","../User/ezCopyAllUsersBySysKey.jsp?Area=V",0,1,"No"],
			["Sales Users","../User/ezCopyAllUsersBySysKey.jsp?Area=C",0,1,"No"],
			//["Service Users","../User/ezCopyAllUsersBySysKey.jsp?Area=S",0,1,"No"],
			["All","../User/ezCopyUser.jsp",0,1,"No"]
		]
*/
	...
	EZ_ADMIN5_8 = [
			["Vendor Users","../User/ezMassSynch.jsp?Area=V",0,1,"No"],
			["Sales Users","../User/ezMassSynch.jsp?Area=C",0,1,"No"]
		]
	*/	
	EZ_ADMIN5_5 = [
			["Vendor Users","",1,1,"No"],
	...
	EZ_ADMIN5_5_1 = [
			["By User Name","../User/ezSearchByUserName.jsp?Area=V",0,1,"No"],
			["By ERP Vendor","../User/ezSearchUserBySoldTo.jsp?Area=V",0,1,"No"],
			["By Partner Function","../User/ezSearchUserByPartnerFunction.jsp?Area=V",0,1,"No"]
	]
	EZ_ADMIN5_5_2 = [
...
/*
	EZ_ADMIN5_5 = [
			["Users Created","../User/ezUserSyncDetails.jsp?type=user",0,1,"No"],
                	["Authorization Failed","",1,1,"No"],
			["No Customers Exists","../User/ezUserSyncDetails.jsp?type=nocust",0,1,"No"],
			["Pay to Sync Failed","../User/ezUserSyncDetails.jsp?type=pay",0,1,"No"],
			["Functional Sync Failed","../User/ezUserSyncDetails.jsp?type=fun",0,1,"No"],
			["Vendor Sync Failed","../User/ezUserSyncDetails.jsp?type=vendor",0,1,"No"],
			["Customer Sync Failed","../User/ezUserSyncDetails.jsp?type=cust",0,1,"No"],
			["Summary","../User/ezUserSummary.jsp",0,1,"No"]
		]

	EZ_ADMIN5_5_1 = [
                   	["Business System Auth","../User/ezUserSyncDetails.jsp?type=bpsysauth",0,1,"No"],
                   	["Business System Ind. Auth","../User/ezUserSyncDetails.jsp?type=bpsysinauth",0,1,"No"],
                   	["User System Auth","../User/ezUserSyncDetails.jsp?type=usersysauth",0,1,"No"],
                   	["User SystemIn Auth","../User/ezUserSyncDetails.jsp?type=usersysinauth",0,1,"No"]
                ]

	EZ_ADMIN5_7 = [
			["Vendor Users","../User/ezResetPasswordBySysKey.jsp?Area=V",0,1,"No"],
			["Sales Users","../User/ezResetPasswordBySysKey.jsp?Area=C",0,1,"No"],
			//["Service Users","../User/ezResetPasswordBySysKey.jsp?Area=S",0,1,"No"],
			["All","../User/ezResetPassword.jsp",0,1,"No"]
		]
*/
	EZ_ADMIN6 = [
			["Mailbox","",1,1,"No"]
	...
	/*EZ_ADMIN6_2 = [
			["List","../Inbox/ezListForums.jsp",0,1,"No"],
			["Add Forum","../Inbox/ezAddForum.jsp",0,1,"No"],
			["Subscribe To Forum","../Inbox/ezSubscribeForums.jsp",0,1,"No"],
			["Post Message","../Inbox/ezComposeForumMsg.jsp",0,1,"No"]
		]
	EZ_ADMIN6_3 = [
			["Processed Msgs","../TransMsg/ezListTransMsgs.jsp",0,1,"No"],
			["To be Processed Msgs","../TransMsg/ezListToBeTransMsgs.jsp",0,1,"No"]
		]*/
	EZ_ADMIN6_2 = [
	...
	*/
	...
	/*EZ_ADMIN7_4 = [
			["By Service Area","../WebStats/ezListWebStatsBySBU.jsp?Area=S",0,1,"No"],
			["User Frequency","../WebStats/ezListUserFrequency.jsp?Area=S",0,1,"No"],
			["Time Stats","../WebStats/ezTimeStats.jsp?Area=S",0,1,"No"]
		]*/
	EZ_ADMIN7_4 = [
	...
	/*EZ_ADMIN7_6 = [
			["List By Site","../Transactions/ezTransListBySite.jsp",0,1,"No"],
			["List By Object","../Transactions/ezTransListByObject.jsp",0,1,"No"],
			["List By ID","../Transactions/ezTransListById.jsp",0,1,"No"]
		]
		*/
	...
	/*EZ_ADMIN7_6 = [
			["Sales Order","../WebStats/ezPreEyeBallView.jsp?type=1",0,1,"No"],
			["Secondary Sales","../WebStats/ezPreEyeBallView.jsp?type=2",0,1,"No"],
			["Misc in Customer Module","../WebStats/ezPreEyeBallView.jsp?type=3",0,1,"No"]
		]
	*/
	EZ_ADMIN7_6 = [
