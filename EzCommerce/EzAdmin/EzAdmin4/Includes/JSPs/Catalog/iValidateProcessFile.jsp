...
<%!
        public Object validateExcel(ReturnObjFromRetrieve maindataObj,java.util.Hashtable validateHT,String[] rFields)
	{
		...
		for(int j=0;j<rFields.length;j++)
		{
		   ...
		   tempHashStr=(String)validateHT.get(rFields[j]);
