...
<%!
	...
	private String fromCondition3(int i,String size)
	{
		...
		FROMCONDITION += "<input type='text' name='lowValue' class = 'InputBox' size='"+size+"' maxlength='"+size+"' readonly nowrap>";
	...
	{
		String TOCONDITION = "";
		TOCONDITION += "<input type='text' name='highValue' class = 'InputBox' size='10' readonly nowrap>";
