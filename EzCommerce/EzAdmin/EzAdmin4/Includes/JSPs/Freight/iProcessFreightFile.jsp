...
<%
	...
	String rFields[] =new String[]{"Service Type",
					"Zone",
					"Country Code",
					"Pack Type",
					"Weight",
	...
	validateHT.put("Service Type","ML¥5");
	validateHT.put("Zone","ML¥5");
	validateHT.put("Country Code","ML¥5");
	validateHT.put("Pack Type","ML¥10");
	validateHT.put("Weight","N¥19");
	validateHT.put("Price","N¥19");
	validateHT.put("Key","ML¥5");
