...
<head>
	...
	<script src="../../Library/JavaScript/User/ezPreQuickAddServiceCustomer.js"></script>
	<script>
		userArray = new Array();
<%
...
<form name=myForm method=post onSubmit = "return chkUserExists()"  action="ezQuickAddServiceCustomer.jsp">
<%
...
<br>
	...
	<Tr>
		<Td class = "displayheader" align = "center">Quick Add Service Customer</Td>
	</Tr>
	</Table>
