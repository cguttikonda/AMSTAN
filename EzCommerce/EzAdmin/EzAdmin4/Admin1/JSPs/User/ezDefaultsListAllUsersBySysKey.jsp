...
<script src="../../Library/JavaScript/User/ezDefaultsListAllUsersBySysKey.js"></script>
<Script src="../../Library/JavaScript/ezTabScroll.js"></script>

</head>
<body bgcolor="#FFFFF7" onLoad="scrollInit();funFocus()" onResize="scrollInit()" scroll="no">
...
%>
	...
	<a href="javascript:funDepAuth('<%=areaLabel.substring(0,areaLabel.length()-1)%>')"><img src="../../Images/Buttons/<%= ButtonDir%>/depdef.gif" border=none></a>
	<a href="javascript:funInDepAuth('<%=areaLabel.substring(0,areaLabel.length()-1)%>')"><img src="../../Images/Buttons/<%= ButtonDir%>/inddef.gif" border=none></a>
	<a href="JavaScript:history.go(-1)"><img src="../../Images/Buttons/<%= ButtonDir%>/back.gif" border=none></a>
