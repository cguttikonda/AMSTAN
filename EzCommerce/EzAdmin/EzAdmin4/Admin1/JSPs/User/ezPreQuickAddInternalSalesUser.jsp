...
<html>
<head>
<Title>Quick Add Sales Internal User</Title>
...
%>
	...
	function SendQuery()
	{
		...
		var url="ezCheckUserInADS.jsp?userId="+document.myForm.userId.value+"&mydate="+ new Date();
		//var url=location.protocol+"//<%=request.getServerName()%>/AST/EzCommerce/EzAdmin/EzAdmin4/Admin1/JSPs/User/ezCheckUserInADS.jsp?userId="+document.myForm.userId.value+"&mydate="+ new Date();
		//var url=location.protocol+"//answerthink.americanstandard.com/AST/EzCommerce/EzAdmin/EzAdmin4/Admin1/JSPs/User/ezCheckUserInADS.jsp?userId="+document.myForm.userId.value+"&mydate="+ new Date();
		//alert(url)
		if(req!=null)
		{
	...
	function Process() 
	{
		if (req.readyState == 4)
		{
			...
			if (req.status == 200)
			{
				if(resText.indexOf("$Y$")!=-1)
				{
					document.myForm.submit();
				}
				else
				{
					alert('User not present in Active Directory')
				}
			}
			else
			{
				if(req.status == 500)
					alert("Error occured while checking in Active Directory");
			}
		}
	}
...
<form name=myForm method=post  action="ezQuickAddInternalSalesUser.jsp">
<%
...
%>
		...
		<Tr>
			<Td class = "displayheader" align = "center" colspan = 4>Quick Add Sales Internal User</Td>
		</Tr>
		<Tr>
			<Th width = "15%" align = "right">User ID*</Th>
			<Td width = "35%"><input type = "text" class = "InputBox" name = "userId" size = 15 maxlength = "20"></Td>
...
%>
		...
		<Tr>
			...
			<Td width = "30%"><input type = "text" class = "InputBox" name = "lastName" size = 15 maxlength = "60"></Td>
...
%>
			...
			<input type='hidden' name='salesOffice' value=''>
		</Tr>
		<Tr>
		<Th align = "right">E Mail*</Th>
			<Td><input type = "text" class = "InputBox" name = "email" size = 20 maxlength = "50"></Td>
		</Tr>
		</Table>
...
%>		
		...
		<div id="ButtonDiv" align="center" style="position:absolute;top:90%;width:100%">
			<a href="JavaScript:checkForADS()"><img src = "../../Images/Buttons/<%= ButtonDir%>/continue.gif" border=none></a>
			<a href="JavaScript:history.go(-1)"><img src="../../Images/Buttons/<%=ButtonDir%>/back.gif" border=none></a>
		</div>
</form>
</html>
