...
<%@ include file="../../../Includes/JSPs/Catalog/iProcessFileByStatus.jsp" %> 
...
%>
		...
		<Tr class="tr">
			...
			<Th width="2%"   align="left">Spec1</Th>
			<Th width="2%"   align="left">Spec2</Th>
			<Th width="2%"   align="left">Spec3</Th>
			<Th width="2%"   align="left">Spec4</Th>
			<Th width="4%"   align="left">Future Price</Th>
			<Th width="6%"   align="left">Effective Date</Th>
			<Th width="2%"   align="left">Weight</Th>
			<Th width="2%"   align="left">Weight UOM</Th>
			<Th width="2%"   align="left">Lead Time</Th>
			<Th width="3%"   align="center">Operation</Th>
		</Tr>
		</Table>
		</Div>
		...
		<%
			...
			dispSizes.add("'6%'");  dispAlign.add("left");
			dispSizes.add("'8%'");  dispAlign.add("left");
			...
			dispSizes.add("'4%'");	 dispAlign.add("left");
			dispSizes.add("'2%'");	 dispAlign.add("left");
			dispSizes.add("'2%'");	 dispAlign.add("left");
			dispSizes.add("'2%'");	 dispAlign.add("left");
			dispSizes.add("'2%'");	 dispAlign.add("left");
			dispSizes.add("'4%'");	 dispAlign.add("left");
		...
		<%
		        ...
		        String MatNo = "",matdesc="",manuFact="",listPrice="",imagePath="",status="",family="",upc="",type="",color="",size="",len="",width="",uom="",finish="",spec1="",spec2="",spec3="",spec4="",futurePrice="",effeectiveDate="",operation="",weight="",weightUOM="",leadTime="";
			String tempItemStr ="";
			String tempCellVal ="";
			...
			for (int i=1;i<dataObjCount;i++)
			{
				...
				futurePrice=  dataObj.getFieldValueString(i,"Future Price");
				effeectiveDate=  dataObj.getFieldValueString(i,"Effective Date");
				//out.println("effeectiveDate:::"+effeectiveDate);
				dataObj_new.setFieldValue("EFCTV_DATE",effeectiveDate);
				dataObj_new.addRow();
				weight  =  dataObj.getFieldValueString(i,"Weight");
				weightUOM  =  dataObj.getFieldValueString(i,"Weight UOM");
				leadTime  =  dataObj.getFieldValueString(i,"Lead Time");
				operation  =  dataObj.getFieldValueString(i,"Operation");
				
				if(matdesc!=null)
				matdesc = matdesc.replace('\'','`');

				tempItemStr = MatNo+"¥"+matdesc+"¥"+manuFact+"¥"+listPrice+"¥"+imagePath+"¥"+status+"¥"+family+"¥"+upc+"¥"+type+"¥"+color+"¥"+size+"¥"+len+"¥"+width+"¥"+uom+"¥"+finish+"¥"+spec1+"¥"+spec2+"¥"+spec3+"¥"+spec4+"¥"+futurePrice+"¥"+effeectiveDate+"¥"+weight+"¥"+weightUOM+"¥"+leadTime+"¥"+operation;
