<%@ include file="../../../Includes/JSPs/Categories/iAttributesInAttrSetList.jsp"%>
...
%>
		...
		<div class="info-box"><br>
			...
			<thead>
			<tr>
				<th width=5% align="center">&nbsp;&nbsp;&nbsp;<Input type="checkbox" name="attributeInAtrId" onclick="funCheckBox()"></th>
				<th width=20%>Attribute Set</th>
...
<%
			String aStatus="";
			for(int i=0;i<cntretAttribueInAtrrList;i++)
			{
			
%>	
				<tr>
					<td width=3% align="center"><Input type="checkbox" name="attrInAtrID" value="<%=retAttribueInAtrrList.getFieldValueString(i,"EASA_SET_ID")%>¥<%=retAttribueInAtrrList.getFieldValueString(i,"EASA_ATTR_ID")%>"></td>
					<td width=20%>&nbsp;<%=retAttribueInAtrrList.getFieldValueString(i,"EASA_SET_ID")%></td>
					<td width=20%>&nbsp;<%=retAttribueInAtrrList.getFieldValueString(i,"EASA_ATTR_ID")%></td>
...
%>
	...
	<div align="center" style="position:relative">
		...
		<a href="ezAddAttributeInAtrSet.jsp"><img src="../../Images/Buttons/<%= ButtonDir%>/add.gif" border=none></a>	
