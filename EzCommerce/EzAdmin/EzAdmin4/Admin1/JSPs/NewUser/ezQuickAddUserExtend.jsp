<Div id="theads">
	...
	<Tr>
		...
		<Td width = "25%"><input type = "text" class = "tx" name = "salesArea" size = 15 maxlength = "10" value="<%=salesArea%>"></Td>
	</Tr>
	<Tr>	
		...
		%>
		<Td width = "25%"><input type = "text" class = "tx" name = "soldTo" size = 30 maxlength = "60" value="<%=soldTo%>"></Td>
	</Tr>
	<Tr>
		<Th width = "25%" align="right">Partner Number</Th>
		<Td width = "25%"><input type = "text" class = "tx" name = "partnerNo" size = 30 maxlength = "60" value='<%=retUserCust.getFieldValueString(0,"EC_BUSINESS_PARTNER")%>'></Td>
	</Tr>
	</Table>	
</Div>
