...
<%@ include file="../../../Includes/JSPs/Freight/iProcessFreightFileDel.jsp" %>
...
<head>
	...
	function selectData()
	{
		...
		if(count == 0)
		{
			alert("Please select atleast one freight row to delete");
			return;
		}
		...
		if(eval(y))
		{
			document.myForm.action = "ezDeleteFreightData.jsp";
	...
	{
	   document.myForm.action="ezDownLoadExcelDel.jsp"; 
...
%>
		...
		<Tr>
			...
			<Th width="20%" align="left">Service Type</Th>
			<Th width="15%" align="left">Zone</th>
			<Th width="15%" align="left">Country Code</th>
			<Th width="15%" align="left">Pack Type</th>
			<Th width="15%" align="left">Weight</th>
			<Th width="15%" align="left">Key</th>
		</Tr>
		</Table>
		</Div>
...
<%
			String sType="",zone="",cCode="",pType="",weight="",tempStr="",key="";
			for (int i=1;i<dataObjCount;i++)
			{
				...
				tempStr    =  sType+"¥"+zone+"¥"+cCode+"¥"+pType+"¥"+weight+"¥"+key;
%>
				
				<Tr>
				<Td width="5%" align="center"><input type="checkbox" name="chk1" value='<%=tempStr%>'></Td>
				<Td width="20%" align="left"><%=sType%></Td> 
				<Td width="15%" align="left"><%=zone%></Td>
				<Td width="15%" align="left"><%=cCode%></Td>
				<Td width="15%" align="left"><%=pType%></Td>
				<Td width="15%" align="right"><%=weight%></Td>
				<Td width="15%" align="left"><%=key%></Td>
				</tr>
<%
                       }
%>
		...
		<center>
			<img src="../../Images/Buttons/<%=ButtonDir%>/delete.gif" border="none" valign=bottom style="cursor:hand" onclick="selectData()"> 
