...
<%
	...
	try
		...
		if(null!=siteId)
			...
			trParams.setSite(siteId);
			trParams.setListMode("SITE");
...
<script src = "../../Library/JavaScript/Transactions/ezTransListBySite.js"></script>
...
<Table  border=1 align='center' borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=2 cellSpacing=0   width="50%">
	...
	Enter the site number<input type=text class = "InputBox" name=siteNum value="">
	</Th>
	<Td>
	<input type=image src="../../Images/Buttons/<%= ButtonDir%>/show.gif" border=no  onClick="return funSubmit()">
	</Td>
	</Tr>
</Table>
<%
...
%>
		...
		<Tr>
		    <Th width="100%" align=center class="displayheader"> Enter The Site Number
	          And Click on Show to View The List of Transactions </Th>
		</Tr>
		</Table>
		<br>
...
%>
			<br><br>
			<Table  border=1 align='center' borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=2 cellSpacing=0   width="80%">
			<Tr><Td class="displayheader" align=center>List of Transactions By Site </Td></Tr>
			</Table>
			<div id="theads">
			<Table  border=1 align='center' borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=2 cellSpacing=0   width="80%">
			<Tr>
