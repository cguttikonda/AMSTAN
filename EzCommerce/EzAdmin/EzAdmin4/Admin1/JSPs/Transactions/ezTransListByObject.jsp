...
<%
	...
	try
		{
		siteId=request.getParameter("obj");
		if(null!=siteId)
			{
			eztrans=new ezc.eztrans.EzTransaction();

			trParams=new ezc.eztrans.EzTransactionParams();
			trParams.setObject(siteId.toUpperCase());
			trParams.setListMode("OBJECT");
...
var tabHeadWidth=80
	...
	<script src="../../Library/JavaScript/Transactions/ezTransListByObject.js"></script>
<script>
function funInit()
	{
...
<BODY onLoad="scrollInit();document.myForm.obj.focus()" scroll=no() >
<br>
...
Enter the Object<input type=text class = "InputBox" name='obj' value=""></Th>
...
<Table  border=1 align='center' borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=2 cellSpacing=0   width="80%">
	<Tr>
	<Th width="100%" align=center>
	Enter The Object And Click on Show to View The List of Transactions
	</Th>
	</Tr>
	</Table>
	<br>
