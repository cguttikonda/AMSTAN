...
function chkRoleExists()
{
	if(chk())
	{
		roleNr = document.myForm.rolenum1ber.value;
		...
		for (var i=0;i<userRoles.length;i++)
		{
			if (roleNr==userRoles[i])
			{
				...
				document.myForm.rolenum1ber.focus();
				return false;
			}
		}
		return true;
...
<body onLoad="document.myForm.rolenum1ber.focus();">
...
<br>
	...
	<Tr>
        	...
        	<Td width="63%"><input type=text class = "InputBox" name="rolenum1ber" maxlength="16"></Td>
      	</Tr>
      	<Tr>
