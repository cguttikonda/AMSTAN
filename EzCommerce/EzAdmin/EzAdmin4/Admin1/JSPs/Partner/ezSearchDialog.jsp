...
<head>
	...
	<Title>Search For Partners By Name--Powered by EzCommerce Gloabl Solutions</Title>
<script>
	function fun1(obj)
	{
		if(obj==2)
...
<br>
<Center>
	<img src="../../Images/Buttons/<%= ButtonDir%>/ok.gif" border=none onClick="fun1(1)" style = "cursor:hand">
	<img src="../../Images/Buttons/<%= ButtonDir%>/cancel.gif" border=none onClick="fun1(2)" style = "cursor:hand">
</Center>
</form>
</body>
</html>