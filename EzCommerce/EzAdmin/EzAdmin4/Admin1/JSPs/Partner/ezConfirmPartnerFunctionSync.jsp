...
<%
		...
		functionDesc.put("AF","Sales Office");
...
for ( int i = 0, j = 0; j < AddRows; j++)
{
	...
	if ( !pFuncId.equals(FUNCTION) )
	{
		...
		String shipN	= addressObj.getFieldValueString(i,"NAME1");
		shipN	= shipN.replaceAll("\'","`");
		String isdisabled = "";
...
%>
		...
		<Tr>
			...
			<Td >
				...
				<input type="hidden" name="CustName" value='<%=shipN%>' >
				...
				<%
					...
					//{
						...
						//{
						int b = busspartnerObj.getRowId("PARTNERNUMBER",partNumb);
						%>
...
<div align = "center" style="position:absolute;top:90%;width:100%">
    <input type="image" src = "../../Images/Buttons/<%= ButtonDir%>/submit.gif" name="Submit" value="Synchronize" onClick="checkAll();return document.returnValue">
