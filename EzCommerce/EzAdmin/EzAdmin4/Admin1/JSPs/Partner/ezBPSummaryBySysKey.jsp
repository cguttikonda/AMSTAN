...
<Table  width="89%" align=center border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=2 cellSpacing=0 >
	<Tr align="center">
      		...
      		<Td width="20%">
			<%=retbpinfo.getFieldValueString("ECA_COMPANY_NAME")%>
      		</Td>
   	</Tr>
</Table>
<%
...
<%
				for ( int i = 0; i < numBPUsers; i++)
				{
					String isBuiltIn = retbpusers.getFieldValueString(i,"EU_IS_BUILT_IN_USER");
		   			...
		   			{
						userUrl = "../User/ezUserDetails.jsp?UserID="+uId+"&AreaStr="+areaStr;
		   			}
%>
					<Tr >
...
%>
			...
			<Td>
				...
				<a href= "../Config/ezSetBusAreaDefaults.jsp?Area=C&SystemKey=<%=catAreaCode%>"><%= catAreaDesc %> (<%=catAreaCode%>)</a>
			</Td>
			</Tr>
<%
		}
