...
<form name=myForm method=post onSubmit="return setDescVal()" action="ezConfirmNewCustSync.jsp">
<br>
<%
...
<Table  border=1 align='center' borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=2 cellSpacing=0   width="89%">
	<Tr align="center">
	<Td class = "displayheader" align = "center">New <%=arTitle%> Synchronization</Td>
	</Tr>
</Table>
<Table  border=1 align='center' borderColorDark="#ffffff" borderColorLight="#000000" cellPadding=2 cellSpacing=0   width="89%">
    	<Tr>
...
<%
	...
	if ( syskeyRows > 0 )
		{
%>
        	<select name="SysKey" onChange="changeArea()" id = ListBoxDiv>
<%
		String sel = "";
		for ( int i = 0 ; i < syskeyRows; i++ )
		{
			...
			//catArea = websyskey;
			  ...
			  {
%>
		        	<option value=<%=(retsyskey.getFieldValue(i,SYSTEM_KEY))%> selected >
...
<%
	if(FUNCTION.equals("AG")) {
%>
        	<Th align = "right" width="60%" class="labelcell" >Please Enter New "Sold To" to be Synchronized:*</Th>
<%
	} else {
%>
...
%>
     	...
     	<input type=text class = "InputBox" name="NonBaseERPSoldTo" style="width:100%" maxlength="10"  value="" onBlur = funSoldTo()>
      	</Td>
    	</Tr>
<%
	}//End for
...
<%
	if(retsyskey.getRowCount() > 0)
		{
%>
  		<input type="image" src="../../Images/Buttons/<%= ButtonDir%>/process.gif" onClick="checkAll('<%=partyType%>');return document.returnValue">
