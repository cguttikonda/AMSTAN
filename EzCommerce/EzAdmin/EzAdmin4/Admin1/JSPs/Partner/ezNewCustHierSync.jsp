...
function hierAll()
{
	...
	document.myForm.action = "ezHierCodeGetAllCust.jsp?hierCode="+document.myForm.hierCode.value;
	document.myForm.submit();
}
</Script>
<%@ include file="../../../Includes/Lib/AddButtonDir.jsp"%></head>
<body onLoad="document.myForm.hierCode.focus();">
...
<%
	if(FUNCTION.equals("AG")) {
%>
        	<Th align = "right" width="60%" class="labelcell" >Please Enter Hierarchy Code to be Synchronized:*</Th>
<%
	} else {
%>
...
%>
     	...
     	<input type=text class = "InputBox" name="hierCode" style="width:100%" maxlength="10"  value="">
      	</Td>
    	</Tr>
<%
	}//End for
...
<%
	if(retsyskey.getRowCount() > 0)
		{
%>
  		<input type="image" src="../../Images/Buttons/<%= ButtonDir%>/process.gif" onClick="hierAll()">
