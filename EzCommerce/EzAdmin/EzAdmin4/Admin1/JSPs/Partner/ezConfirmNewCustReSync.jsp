		...
		if ( pSoldTo != null && !pSoldTo.trim().equals("") )
		{
			...
			if ( buss_cust_retObj != null )
			{
				returnObjCheck = true;
					...
					//out.println(""+busspartnerObj.toEzcString());
				}
				else
				{
...
%>
<form name=myForm method=post action="ezSaveNewCustReSync.jsp">
...
<%
	if(!"Y".equals(ReSynchFlag))
	{
   		...
   		{
%>
	 		<input type="image" src="../../Images/Buttons/<%= ButtonDir%>/continue....gif" name="Submit" value="Synchronize" onClick="checkAll(<%=fCount%>);return document.returnValue">
