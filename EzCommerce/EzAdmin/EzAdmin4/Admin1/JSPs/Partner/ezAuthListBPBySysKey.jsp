...
<%@ include file="../../../Includes/Lib/AddButtonDir.jsp"%>
	<script src="../../Library/JavaScript/Partner/ezAuthListBPBySysKey.js"></script>
...
<%
		...
		{
%>
	<body onLoad='scrollInit();document.myForm.WebSysKey.focus()' onResize='scrollInit()'  scroll='no'>
<%
		}
		else
		{
...
%>
<br>
<form name=myForm method=post action="ezAuthListBPBySysKey.jsp" onSubmit="return chkSubmit()">
...
%>
				...
				<label for="cb_<%=j%>">
					...
					<input type="hidden" name="BPDesch" value= '<%=chkKey%>' ></Td>
...
%>
				...
				<div style="position:absolute;visibility:visible;top:90%;left:5%">
		<Table>
		<Tr>
