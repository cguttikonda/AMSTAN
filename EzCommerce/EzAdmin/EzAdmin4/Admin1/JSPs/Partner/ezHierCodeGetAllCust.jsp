...
function funSynchHier()
{
	...
	document.myForm.action="ezHierCodeSyncAllCust.jsp"
...
<%
	...
	String bPartnerDesc   	=  request.getParameter("BusPartnerDesc");
	...
	{
		if(sysKey.equals(ret.getFieldValue(i,SYSTEM_KEY)))
		{
...
%>
		<a href= "../Config/ezSetBusAreaDefaults.jsp?Area=<%=areaFlag%>&SystemKey=<%=sysKey%>"><%= wsk %> (<%=sysKey%>)&nbsp;</a>
	</Td>
      	<Th width="18%" align="right">Business Partner:</Th>
      	<Td width="26%" align = "left">

	<a href = "../Partner/ezBPSummaryBySysKey.jsp?WebSysKey=<%=sysKey%>&Area=<%=areaFlag%>&BusinessPartner=<%=bPartner%>"><%=bPartnerDesc%></a>
      	</Td>
	</Tr>
	</Table>
...
%>
		...
		<div id="ButtonDiv" align="center" style="position:overflow;width:100%">
