...
<%
	...
	// ezc.client.EzSystemConfigManager ezsc = new ezc.client.EzSystemConfigManager(); // Changed 10/06/200 : Nitin
	...
	sysManager.updateUserGroups(sparams);
	...
	{
		response.sendRedirect("../CParam/ezAlertSuccess.jsp?SystemNumber=" + ERPSystemNumber + "&GrpId=" + GroupID);
	}
%>
</body>
</html>
