...
<%
	...
	String setDateVal = null;
	/*if((fromDate!=null && toDate!=null) || !("null".equals(fromDate))&&("null".equals(toDate)) ){
		if(fromDate.equals(toDate)){
		java.util.Date setDay = new java.util.Date();
		setDay.setDate(((new java.util.Date(toDate)).getDate()-1));
		setDay.setMonth(((setDay).getMonth()-1));
		ezc.ezutil.FormatDate format = new ezc.ezutil.FormatDate();
		setDateVal = format.getStringFromDate(setDay,"/",ezc.ezutil.FormatDate.MMDDYYYY);
...
<%
	////out.println("setDateVal>>"+setDateVal);
	if ( sysRows > 0 )
	{
%>
