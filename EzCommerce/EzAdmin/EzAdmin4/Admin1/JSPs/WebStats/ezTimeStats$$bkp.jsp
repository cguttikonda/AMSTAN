...
<%
        ...
        <a href="javascript:showCal('document.myForm.fromDate',50,250)"> <img border=no style="cursor:hand" src="../../Library/JavaScript/calender.gif" alt = "Calender" align="middle" >
        </a> </nobr></Td>
		   <Th>To</Th>
		   <Td><nobr><input type=text class = "InputBox" name="toDate" size=11 value="<%=toDate%>" readonly>
        <a href="javascript:showCal('document.myForm.toDate',50,250)"><img border=no style="cursor:hand" src="../../Library/JavaScript/calender.gif" alt = "Calender" align="middle" >
        </a></nobr></Td>
