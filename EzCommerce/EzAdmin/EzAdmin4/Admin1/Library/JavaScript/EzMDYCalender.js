...
function fSetSelectedToday(fieldName)
{
	...
	if (formatDate==1)
		...
		tt.value=tYear+DateFarmat+tMonth+DateFarmat+tDate
	...
	if (myElement.id == "calCell") 
	{
		if (!isNaN(parseInt(myElement.children["calDateText"].innerText))) 
		{
			...
			if (formatDate==1)
				...
				tt.value=rYear+DateFarmat+rMonth+DateFarmat+rDate
...
function showCal(fieldName,t1,l1,CD,CM,CY) 
{
	...
	if(divToPopUp==null || ezDiv.style.visibility=="hidden")
	{
		...
		text +="<font id='calTodayDateText'  color="+DateText_FontColor+"  style='CURSOR:Hand;FONT-FAMILY:"+DateText_FontFamily+";FONT-SIZE:" + DateTextSize + ";FONT-WEIGHT:" + DateTextWeight + "'> Today&nbsp;:&nbsp;&nbsp;"+curYear+""+curMonth+""+curDate+"</font>"
		text +="</Td></Tr>"
		text +="</Table>"
		text +="</Td></Tr></Table>"
		text +="</Td></Tr></Table>"
