...
function funsubmit1(area)
{
	...
	*/
	if(document.myForm.WebSysKey.selectedIndex != 0)
	{
		...
		document.myForm.action="ezAuthListAllUsersBySysKey.jsp";
...
if(document.myForm.WebSysKey.selectedIndex != 0)
{
	...
	if(isNaN(wsk))
	{
		...
		{
			alert("Please Select User to Get dependent Authorizations");
		}
	}
	else
	{
...
if(document.myForm.WebSysKey.selectedIndex != 0)
{
	...
	if(isNaN(wsk))
	{
		if(document.myForm.chk1.checked==true)
		{
			...
			//document.myForm.BusUser.value=document.myForm.chk1.value;
			document.myForm.action="ezUserEzcAuthListBySysKey.jsp"
			document.myForm.submit();
		}
		else
		{
			alert("Please Select User to Get Independent Authorizations");
		}
	}
	else
	{
...
function ezSearch()
{
	...
	if(searchstring!=null)
	{
		if(searchstring.length!=0)
		{
			document.myForm.action="ezAuthListAllUsersBySysKey.jsp?from=Search";
			document.myForm.submit();
