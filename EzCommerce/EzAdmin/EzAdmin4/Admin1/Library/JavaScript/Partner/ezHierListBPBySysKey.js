...
function funsubmit()
{
	...
	if(document.myForm.WebSysKey.selectedIndex != 0)
	{
		...
		document.myForm.action="ezHierListBPBySysKey.jsp";
...
if(document.myForm.WebSysKey.selectedIndex != 0)
{
	...
	if(isNaN(wsk))
	{
		if(document.myForm.chk1.checked)
		{
			...
			document.myForm.action="ezBPHierSyncBySysKey.jsp"
			document.myForm.submit();
...
function ezSearch()
{
	...
	if(searchstring!=null)
	{
		if(searchstring.length!=0)
		{
			if(document.myForm.WebSysKey.selectedIndex != 0)
			{
				document.myForm.action="ezHierListBPBySysKey.jsp?from=Search";
				document.myForm.submit();
			}
		}
	}
