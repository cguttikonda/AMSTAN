...
{
	document.location.href="ezTemplateCodeList.jsp"
}
...
function chkForLevel(myForm)
{
		...
		if(!(isNaN(chkLength)))
		{
			...
			if(count !=1)
			{
				alert("Please check Only one checkbox which you want to view Organogram Levels")
				return false;
			}
