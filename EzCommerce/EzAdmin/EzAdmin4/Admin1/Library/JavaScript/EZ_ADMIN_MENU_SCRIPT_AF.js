...
function ezMakeDiv(menuNo)
{
	...
	for(var k=0;k<currentArray.length;k++)
	{
		...
		if(currentArray[k][2]==1)
		{
			...
			if(top.display.document.getElementById("MenuSol_R") == null){
				ezAddMenuItem(divId,currentArray,k,isLast,nextSub);
			}else{
				ezAddMenuItem1(divId,currentArray,k,isLast,nextSub);
			}
		...
		else
		{
				...
				ezAddMenuItem1(divId,currentArray,k,isLast,0)
			}
		}
	}
}
...
function ezAddMenuItem1(divId1,currentArray,arrSubscr,isLast,nextSub)
{

	if(top.display.document.getElementById("MenuSol") != null){
	itemVal=currentArray[arrSubscr][0]
	itemLink=currentArray[arrSubscr][1]
	hasSub=currentArray[arrSubscr][2]
	itemTarget=currentArray[arrSubscr][3]
