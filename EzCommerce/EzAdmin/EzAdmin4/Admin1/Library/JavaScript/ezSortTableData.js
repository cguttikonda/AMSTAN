...
var formatType="MM"+separator+"DD"+separator+"YYYY"
...
//	var OuterdivId=document.getElementById("OuterBox1Div")
   ...
   if(InnerdivId!=null) //&& OuterdivId!=null) //if rowCount!=0
   {
	  ...
	  try
	  {
	      ...
	      initialData[t]=ezTab.rows(t).outerHTML
		
	}catch(varError)
  	{
  	  //alert("problem in ezInitSorting()")
  	  return
  	}
...
function ezWriteData()
{
	...
	tabData='<Table  align=center border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=2 cellSpacing=0 width="100%" id="ezTab">'
	try
	{
	        for(i=0;i<rowCount;i++)
