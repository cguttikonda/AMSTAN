...
function funEmail(sValue,sthis) 
{	var s="";
	invalidChars = "' /:,;";
	if (sValue == "")
	{
	...
	if (atPos == -1)
	{
		msgString = "You need to provide your Email UserId. i.e  your email should be in this format info@DataEdgeInc.com ."
		alert(msgString);
		//sthis.focus();
		return false;
	}
			...
			{				
				...
				switch (sCheckType)
				{
					...
					case "MIN":		bRetValue=funMin(sField.value);
								...
								break;
					case "EMAIL":	bRetValue=funEmail(sField.value,sFieldName);
								if(! bRetValue)
								{
									bValid="N";
								}
