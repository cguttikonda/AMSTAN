...
<a href="../../../../../ezLogin.jsp" title="American Standard" class="logo"><img src="../Styles/logorevised.png" alt="American Standard" height="55px" width="237px"></a><!--Images/amstd_logo.bmp-->
</form>
...
<Div id='inputDiv' class="roundedCorners" style="position:relative;top: 30px;left: 10%;width: 650px;height: 120px;background-color: rgb(247, 247, 247);text-align: center;padding-top: 60px;padding-bottom: 0px;">
...
<!--<Table width="60%" height="20%" border="0" cellspacing="0" cellpadding="0" align=center valign=center style="margin:0 auto;">
<Tr>
...
<%@ include file="../../JSPs/Misc/ezFooter.jsp"%>
