<%!
 	private String[][] verifyProductRules()
	{
		...
		java.util.ArrayList cartDXVAL = new java.util.ArrayList();
		...
		if(myRetTemp!=null && myRetTemp.getRowCount()>0)
		{
			for(int u=0;u<myRetTemp.getRowCount();u++)
			{
				...
				if("D1".equals(prodDiv) || "D2".equals(prodDiv) || "D3".equals(prodDiv) || "D4".equals(prodDiv) || "D5".equals(prodDiv))
				{
					if(cartDXVAL.contains("DXV5") || (cartDXVAL.contains("DXV9") && !cartDXVAL.contains("NDXV")))
					{
						dxvChk = true;
					}
				}
				...
				{
					if(cartDXVAL.contains("NDXV") || (cartDXVAL.contains("DXV9") && !cartDXVAL.contains("DXV5")))
					{
						dxvChk = true;
					}				
				}
