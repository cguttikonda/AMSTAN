...
<%
	...
	//query="SELECT TOP 10 EZP_PRODUCT_CODE,EPD_PRODUCT_DESC  PROD_DESC,EZP_STATUS STATUS,EZP_ATTR1 EXCLUSIVE FROM EZC_CATEGORY_PRODUCTS,EZC_PRODUCTS,EZC_PRODUCT_ATTRIBUTES,EZC_PRODUCT_DESCRIPTIONS WHERE ECP_PRODUCT_CODE = EZP_PRODUCT_CODE AND EPD_PRODUCT_CODE = EZP_PRODUCT_CODE AND EZP_STATUS NOT IN ('Z3','Z2','11','ZM')  and (EZP_PRODUCT_CODE LIKE '"+strMat+"%' OR EPD_PRODUCT_DESC LIKE '"+strMat+"%') GROUP BY EZP_PRODUCT_CODE,EPD_PRODUCT_DESC,EZP_STATUS,EZP_ATTR1 ORDER BY EPD_PRODUCT_DESC";
