...
<%
	try
	{
		String newsFlag = request.getParameter("flag");
		...
		if(newsFlag!=null && !"null".equals(newsFlag) && !"N".equals(newsFlag) )
			response.sendRedirect("ezAttachment.jsp?attachedFiles="+fname+""+attachedFiles);
		else
			response.sendRedirect("../News/ezNewsAttachment.jsp?attachedFiles="+fname+""+attachedFiles);
	}
	catch(Exception e)
	{
