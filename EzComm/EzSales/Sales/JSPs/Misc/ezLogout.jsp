...
<%
		...
		String logoutCart = request.getParameter("logoutCart");
		
		if("N".equals(logoutCart))
		{
%>
		<%@ include file="../ShoppingCart/ezAddPersistentCart.jsp"%>
...
<%		}
	...
	{
%>
		<meta http-equiv="refresh" content="2;url=/AST/ezLogin.jsp">
<%
	}
	//ezc.ezcommon.EzLog4j.log("Session::::::"+Session.logOut(),"D");
%>
...
%>
					...
					browser doesn't support the refresh tag click <b><a href="../../../../../ezLogin.jsp">here</a></b>
