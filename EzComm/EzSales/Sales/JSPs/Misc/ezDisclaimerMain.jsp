...
<%
	...
	if(disclaimerStamp==null || "null".equals(disclaimerStamp))
		disclaimerStamp="N";
%>
<body onLoad=init('<%=disclaimerStamp%>') class=" customer-account-index"><div style="visibility: hidden; height: 1px; width: 1px; position: absolute; z-index: 100000; " id="_atssh">
<form name="myForm">
...
<%
	String helpKey	="EZDISCLAMERMAIN";
%>
<%@ include file="ezHeader.jsp"%>
<%@ include file="ezMenu.jsp"%>
<%@ include file="ezDisclaimer.jsp"%>
