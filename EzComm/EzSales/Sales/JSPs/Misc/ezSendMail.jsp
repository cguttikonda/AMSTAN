...
<jsp:useBean id="Manager" class="ezc.client.EzMessagingManager" scope="session"></jsp:useBean>
<jsp:useBean id="ForumsManager" class="ezc.client.EzForumsManager" scope="session"></jsp:useBean>
<jsp:useBean id="TransManager" class="ezc.client.EzTransactionManager" scope="session"></jsp:useBean>
...
<%
	...
	String userRole_SM = (String)session.getValue("UserRole");
	//if("CU".equals(userRole_SM))
		//sendToUser = "a@a.com";
