...
<%
	...
	custVec.addElement("0855600000");
	custVec.addElement("0855600001");
	custVec.addElement("0855609999");
	custVec.addElement("0855900000");
	custVec.addElement("0855909999");
	String UserId = "CWHITAKER";
