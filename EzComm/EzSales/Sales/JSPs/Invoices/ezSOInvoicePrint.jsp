		 ...
		 if ("PDF".equals(type))
		 {
			 ...
			 try
			 {
				...
				try{
					...
					ezc.ezcommon.EzLog4j.log("============>1234--> SIZE OF RECEIVED BYTEARRAY "+Z_STRING.size()+,"I"); 
					sos=response.getOutputStream();           
					sos.write(Z_STRING);
				}catch(Exception err){
				ezc.ezcommon.EzLog4j.log("============>1234--> send o/p Stream for Invoice output for Delivery nr "+sonum+,"I"); 
				showPDF = false;
				}
