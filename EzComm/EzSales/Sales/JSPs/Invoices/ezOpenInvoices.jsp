...
<meta name="keywords" content="ME-commerce">
...
<% ezc.record.util.EzOrderedDictionary userAuth_R = Session.getUserAuth();
    if(userAuth_R.containsKey("VIEW_INVOICES")) {
 %>   
 <%@ include file="../Invoices/ezOpenInvoicesList.jsp"%>
 <% } else { 
 	request.setAttribute("authKey","VIEW_INVOICES");
 %>
