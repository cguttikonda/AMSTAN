<%@ include file="../../../Includes/JSPs/Catalog/iCatalogListByClassification.jsp"%>
<div class="main-container col2-left-layout">
<div class="main">
	<div class="breadcrumbs">
		<ul>
		<li class="home"><a href="../Misc/ezDashBoard.jsp" title="Go to Home Page">Home</a></li>
		<li class="category3"><span>/&nbsp;</span><a href="javascript:void(0)" ><%=myLabel%></a></li>
		</ul>
	</div>
<div class="col-main">
...
<script type="text/javascript">
	function getSubCatalogList(catId)
	{
...
<%
		...
		String categoryId = 	catalogsListObj.getFieldValueString(i,"CLASSIFICATION_ID");			
		String categoryDesc = 	catalogsListObj.getFieldValueString(i,"CLASSIFICATION_DESC");
		String categoryLongDesc = 	catalogsListObj.getFieldValueString(i,"LONG_TEXT");

		String catType = catalogsListObj.getFieldValueString(i,"TYPE");
...
%>
		<li class="<%=css_class%>">
			<a href="javascript:getProducts('<%=categoryId%>', '<%=categoryDesc%>','<%=catType%>')" title="<%=categoryDesc%>" class="product-image">
			<img src="Images/Categories/<%=categoryId%>.jpg" width="192" height="215" alt="<%=categoryDesc%>"></a>
			<h2 class="product-name"><a href="javascript:getProducts('<%=categoryId%>','<%=categoryDesc%>','<%=catType%>')" ><%=categoryDesc%></a></h2>
...
<script type="text/javascript">
	...
	function getProducts(classificationId, classDesc, catType)
	{
		document.myForm.classificationID.value=classificationId;
		document.myForm.classDesc.value= classDesc;
		document.myForm.catType.value= catType;
...
<input type="hidden" name="classDesc">
...
<%
	for(int i=0;i<catalogsListObj.getRowCount();i++)
	{
		...
		String catType = catalogsListObj.getFieldValueString(i,"TYPE");
%>
		<dt class="adj-nav-dt odd">
		<li>
		<a href="javascript:getProducts('<%=categoryId%>','<%=categoryDesc%>','<%=catType%>')" ><%=categoryDesc%></a>
...
%>
				...
				<a href="javascript:getProducts('<%=subCategoryId%>')"><%=subCategoryDesc%></a>
				</li>
<%
			}
		}	
