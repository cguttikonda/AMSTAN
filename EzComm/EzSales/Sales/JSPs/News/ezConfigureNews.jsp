...
<%
	ezc.record.util.EzOrderedDictionary userAuthNews = Session.getUserAuth();
	//if(userAuthNews.containsKey("EZC_PUBLISH_NEWS"))
	//{
%>
<%@ include file="../News/ezConfigureNewsBody.jsp"%>
<% 	
	//} 
	//else 
	//{ 
