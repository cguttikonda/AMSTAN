...
<title>Saved Order Templates</title>
...
<%
	String helpKey	="EZSAVEDORDERS";
%>
<%@ include file="../Misc/ezHeader.jsp"%>
<%@ include file="../Misc/ezMenu.jsp"%>
<% ezc.record.util.EzOrderedDictionary userAuth_R2 = Session.getUserAuth();
    if(userAuth_R2.containsKey("ORDER_SEARCH")) {
 %>   
<%@ include file="ezSavedOrdersBody.jsp"%>
 <% } else { 
