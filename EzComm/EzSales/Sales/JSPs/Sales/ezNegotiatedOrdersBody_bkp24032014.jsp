 ...
 var xmlHttp
	...
	function getShipTos()
	{
		...
		if(selSoldTo!="")
		{
			...
			if(xmlHttp!=null)
			{
				var url = "ezGetShipTos.jsp?selSoldTo="+selSoldTo;
	...
	function process()
	{
		...
		{
			Popup.hide('modal');
			var resText = xmlHttp.responseText;alert("resText:::"+resText)
			document.getElementById("shipTo").innerHTML=unescape(resText);
		}
	}	
	/*{
		Popup.showModal('headermodal');	
