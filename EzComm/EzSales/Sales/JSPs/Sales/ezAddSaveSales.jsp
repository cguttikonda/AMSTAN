...
<%
	...
	String NegFlag		= request.getParameter("NegFlag"); //This flag is to insert data into negotiated tables for saved order.
	String eddFlag		= request.getParameter("setEDDFlag"); // Flag for Expected Delivery Date
	...
	String webOrdNo_C	= request.getParameter("webNO"); // weborder No from Saved Orders to insert as ref no in sales doc header.
	log4j.log("webOrdNo_C::::::::"+webOrdNo_C,"D");
	...
	String[] itemMultiplier	= request.getParameterValues("stdMultiplier");
	...
	if(dupReq==null || "null".equalsIgnoreCase(dupReq)) dupReq = "N";
