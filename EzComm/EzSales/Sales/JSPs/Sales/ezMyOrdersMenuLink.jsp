...
<%
		...
		if(!"null".equals((String)session.getValue("DISPCNT_CM")) && session.getValue("DISPCNT_CM")!=null)
			dispCnt_CM = " ["+(String)session.getValue("DISPCNT_CM")+"]";
...
%>
			...
			<ul>
<%
			if("ezNegotiatedOrders.jsp".equals(pageNmae) && "INPROCESS".equals(request.getParameter("negotiateType")) && "C".equals(request.getParameter("displayOrder")))
			{
%>
				<div class="orderDBleftMenu">
...
%>				
				<li><a href="javascript:funClick('ezNegotiatedOrders.jsp?negotiateType=INPROCESS&ORDERTYPE=N&displayOrder=C')">ASB Queue<%=negoCnt_CU%></a></li>
<%
			}
			if("ezNegotiatedOrders.jsp".equals(pageNmae) && "ACCEPTED".equals(request.getParameter("negotiateType")) && "C".equals(request.getParameter("displayOrder")))	
			{
%>
				<div class="orderDBleftMenu">
...
%>	
				<li><a href="javascript:funClick('ezNegotiatedOrders.jsp?negotiateType=ACCEPTED&ORDERTYPE=N&displayOrder=C')">Customer Queue <%=inqCnt_CU%></a></li>
<%
			}
			if("ezNegotiatedOrders.jsp".equals(pageNmae) && "CLOSED".equals(request.getParameter("negotiateType")) && "C".equals(request.getParameter("displayOrder")))
			{
%>
				<div class="orderDBleftMenu">
...
%>
				<li><a href="javascript:funClick('ezNegotiatedOrders.jsp?negotiateType=CLOSED&ORDERTYPE=N&displayOrder=C')">Closed </a></li>
<%
			}
%>
			</ul>	
...
%>
			...
			<ul>
<%
				if("ezNegotiatedOrders.jsp".equals(pageNmae) && "INPROCESS".equals(request.getParameter("negotiateType")) && "N".equals(request.getParameter("displayOrder")))
				{
%>
					<div class="orderDBleftMenu">
...
%>	
					<li><a href="javascript:funClick('ezNegotiatedOrders.jsp?negotiateType=INPROCESS&ORDERTYPE=N&displayOrder=N')">ASB Queue<%=negoCnt_CM%></a></li>
<%
				}
				if("ezNegotiatedOrders.jsp".equals(pageNmae) && "INPROCESS".equals(request.getParameter("negotiateType")) && "Y".equals(request.getParameter("displayOrder")))
				{
%>
					<div class="orderDBleftMenu">
						<strong><span>Display Orders Queue<%=dispCnt_CM%></span></strong>
					</div>
<%
				}else{
%>	
					<li><a href="javascript:funClick('ezNegotiatedOrders.jsp?negotiateType=INPROCESS&ORDERTYPE=N&displayOrder=Y')">Display Orders Queue<%=dispCnt_CM%></a></li>
<%
				}				
				if("ezNegotiatedOrders.jsp".equals(pageNmae) && "ACCEPTED".equals(request.getParameter("negotiateType")) && "C".equals(request.getParameter("displayOrder")))	
				{
...
%>
					<li><a href="javascript:funClick('ezNegotiatedOrders.jsp?negotiateType=ACCEPTED&ORDERTYPE=N&displayOrder=C')">Customer Queue</a></li>
<%
				}
				if("ezNegotiatedOrders.jsp".equals(pageNmae) && "CLOSED".equals(request.getParameter("negotiateType")) && "C".equals(request.getParameter("displayOrder")))
				{
...
%>
			...
			<ul>
<%
			if("ezSavedOrders.jsp".equals(pageNmae) && "C".equals(request.getParameter("displayOrder")))	
			{
%>		
				<div class="orderDBleftMenu">
					<strong><span>Saved Orders<%=saveCnt%></span></strong>
...
%>		
				<li><a href="javascript:funClick('ezSavedOrders.jsp?displayOrder=C')">Saved Orders<%=saveCnt%></a></li>
<%		
			}
%>
			</ul>	
