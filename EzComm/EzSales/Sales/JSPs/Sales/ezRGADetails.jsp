 ...
 <html lang="en">
 <head>
 <title>Request RGA</title>
 <%@ include file="../../../Includes/Lib/ezCommonHead.jsp"%>
 <style>
 /*body { font-family: proxima-nova, "Helvetica Neue", Arial, Helvetica, Geneva, sans-serif; font-size: 13px; line-height: 18px; color: #4f4f4f; background: #A0A0A0; text-align: left; }*/
 </style>
 </head>
 ...
 <%@ include file="../Sales/ezRGADetailsBody.jsp"%>
