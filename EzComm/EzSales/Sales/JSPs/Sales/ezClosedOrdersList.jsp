...
<Script src="../../Library/Script/popup.js"></Script> 
 ...
 %> 
 <%@ include file="../../../Includes/JSPs/Sales/iClosedOrdersList.jsp"%>
 <%
 	String searchStat = request.getParameter("searchStat");
 		
 	//String dispHeader = "No Closed Orders";
 
 	//if(cnt>0)
 	String	dispHeader = "Closed Orders";
 ...
 <script type="text/javascript">
 	function getOrders()
 	{
 		...
 		document.myForm.action="ezClosedSalesOrders.jsp";
 ...
 <div id="modal1" align ="center" style="border:0px solid black; background-color:white; padding:1px; font-size:10;width:40%;height:40%; text-align:center; display:none;">
 	<ul>
 		<li>&nbsp;</li>
 ...
 <input type="hidden" name="allSolds" value="ALL">
 <ul class="form-list">
 	<li>
 	<div id="it">
...
<input type="hidden" name="poDate">
 ...
 <%
 		...
 		for(int i=0;i<cnt;i++)
 		{
			...
			//if (pono.equals("94214")){
			//	out.println("Doc type -->"+docType);
			//}
			StringTokenizer st1 = new StringTokenizer(DocDate,"/");
 			String[] docsplit = new String[3];
 			int h=0;
