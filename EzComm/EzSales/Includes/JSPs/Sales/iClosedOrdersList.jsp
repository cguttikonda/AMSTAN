...
<% 
	...
	iParams.setStatusFlag("A");	//'C' for closed
	...
	try
	{
		...
		{
			//out.println("ISCHECKED:::::::::::::::::::::"+retCatManager.getFieldValueString(i,"ISCHECKED"));
	...
	if("CU".equals(userRole) && "ALL".equals(request.getParameter("allSolds")))
	{
	...
	for(int d=orderList.getRowCount()-1;d>=0;d--)
	{
		String asbStatus = orderList.getFieldValueString(d,"EzDocStatus");
		if(!"C".equals(asbStatus))
			orderList.deleteRow(d);
	}
	if(orderList!=null) cnt = orderList.getRowCount();
	if(cnt>0)
	{
