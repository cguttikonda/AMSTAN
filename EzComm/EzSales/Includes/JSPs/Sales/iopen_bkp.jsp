 		...
 		if ( itemOutTable != null )
 		{
 			if (itemOutTable.getNumRows() > 0)
 			{
 				do
 				{
 					...
 					division = pricGrpParams[0];
 					ph1 = pricGrpParams[1];
 					mg1 = pricGrpParams[2];
 					mg5 = pricGrpParams[3];
 					commGrp = pricGrpParams[4];
 					if (    "22".equals(division) ||
 						"23".equals(division) ||
 						"24".equals(division) ||
 						"47".equals(division) ||
 						"25".equals(division) ||
 					...
 					else if (   ( "14".equals(division) ||
 						     "55".equals(division) ||
 						     "14".equals(ph1) ||
 						     "55".equals(ph1) ) && (!"ALX".equals(mg1)) ){
