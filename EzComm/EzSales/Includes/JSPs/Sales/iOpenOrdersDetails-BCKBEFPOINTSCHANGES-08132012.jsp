...
<%
	...
	if(retLineText!=null && retLineText.getRowCount()>0)
	{
		...
		for(int l=0;l<retLineText.getRowCount();l++)
		{
			...
			if("ZB2B".equals(retLineText.getFieldValueString(l,"TEXT_NO")) && appendScacText) {
				if (appendScacText)
	...
	String skey_SO = "999";
 	...
 	try
 	{
		...
		//out.println("++++++++ STEP6 DEL HEADERS READ");
	...
	{	
		for(int i=0;i<dlvDocItemsRetObjCnt;i++)
		{
			...
			if("LF".equals(dlvDocType) || "ZD".equals(dlvDocType) || "EL".equals(dlvDocType))
			{
