...
// ADDED TO GET CLASSIFICATION AND ITS DESCRIPTION 
	...
	catalogParams.setIdenKey("MISC_SELECT");
	if ( categoryID != null && !"null".equals(categoryID))
	query="SELECT  ECP_CATEGORY_CODE,EZP_PRODUCT_CODE,EPD_PRODUCT_DESC PROD_DESC,EZP_TYPE,EZP_SUB_TYPE, EZP_STATUS,EZP_WEB_SKU,EZP_WEB_PROD_ID,EZP_UPC_CODE,EZP_ERP_CODE,EZP_BRAND,EZP_FAMILY,EZP_MODEL,EZP_COLOR, EZP_FINISH,EZP_SIZE,EZP_LENGTH,EZP_WIDTH,EZP_LENGTH_UOM,EZP_WEIGHT,EZP_WEIGHT_UOM,EZP_VOLUME,EZP_VOLUME_UOM, EZP_STYLE,EZP_NEW_FROM,EZP_NEW_TO,EZP_CURR_PRICE,EZP_CURR_EFF_DATE,EZP_FUTURE_PRICE,EZP_FUTURE_EFF_DATE, EZP_FEATURED,EZP_DISCONTINUED,EZP_DISCONTINUE_DATE,EZP_REPLACES_ITEM,EZP_ALTERNATE1,EZP_ALTERNATE2,EZP_ALTERNATE3,EZP_ATTR1,EZP_ATTR2,EZP_ATTR3,EZP_ATTR4,EZP_ATTR5,EZP_SALES_ORG, EZP_PROD_ATTRS FROM EZC_CATEGORY_PRODUCTS, EZC_PRODUCTS,EZC_PRODUCT_DESCRIPTIONS WHERE ECP_PRODUCT_CODE = EZP_PRODUCT_CODE AND ECP_CATEGORY_CODE = '"+categoryID+"' AND  EZP_STATUS NOT IN ('Z2','Z3','01','ZR','ZM','ZL','ZE','ZD','ZP') AND EPD_LANG_CODE= 'EN'  AND EPD_PRODUCT_CODE = EZP_PRODUCT_CODE  ORDER BY EZP_ATTR3 desc ";  //"+filterQryStr+" 
	if ( classificationID != null && !"null".equals(classificationID))
	query="SELECT  ECP_CLASSIFICATION_CODE,EZP_PRODUCT_CODE,EPD_PRODUCT_DESC PROD_DESC,EZP_TYPE,EZP_SUB_TYPE,EZP_STATUS,EZP_WEB_SKU,EZP_WEB_PROD_ID,EZP_UPC_CODE,EZP_ERP_CODE,EZP_BRAND,EZP_FAMILY,EZP_MODEL,EZP_COLOR,EZP_FINISH,EZP_SIZE,EZP_LENGTH,EZP_WIDTH,EZP_LENGTH_UOM,EZP_WEIGHT,EZP_WEIGHT_UOM,EZP_VOLUME,EZP_VOLUME_UOM,EZP_STYLE,EZP_NEW_FROM,EZP_NEW_TO,EZP_CURR_PRICE,EZP_CURR_EFF_DATE,EZP_FUTURE_PRICE,EZP_FUTURE_EFF_DATE,EZP_FEATURED,EZP_DISCONTINUED,EZP_DISCONTINUE_DATE,EZP_REPLACES_ITEM,EZP_ALTERNATE1,EZP_ALTERNATE2,EZP_ALTERNATE3,EZP_ATTR1,EZP_ATTR2,EZP_ATTR3,EZP_ATTR4,EZP_ATTR5,EZP_SALES_ORG, EZP_PROD_ATTRS FROM EZC_CLASSIFICATION_PRODUCTS,EZC_PRODUCTS,EZC_PRODUCT_DESCRIPTIONS WHERE ECP_PRODUCT_CODE = EZP_PRODUCT_CODE AND ECP_CLASSIFICATION_CODE = '"+classificationID+"' AND EZP_STATUS NOT IN ('Z2','Z3','01','ZR','ZM','ZL','ZE','ZD','ZP') AND EPD_LANG_CODE= 'EN'  AND EPD_PRODUCT_CODE = EZP_PRODUCT_CODE ORDER BY EZP_ATTR3 desc ";  //"+filterQryStr+" 
	catalogParams.setQuery(query);
//out.println(query);
	catalogParamsMisc.setLocalStore("Y");
	catalogParamsMisc.setObject(catalogParams);
	...
	catalogParams.setIdenKey("MISC_SELECT");
	if ( categoryID != null && !"null".equals(categoryID))
	query="SELECT * FROM (SELECT TOP "+pageSize+" * FROM (SELECT TOP "+pageMaxNo+" ECP_CATEGORY_CODE,EZP_PRODUCT_CODE,EPD_PRODUCT_DESC PROD_DESC,EZP_TYPE,EZP_SUB_TYPE,EZP_STATUS,EZP_WEB_SKU,EZP_WEB_PROD_ID,EZP_UPC_CODE,EZP_ERP_CODE,EZP_BRAND, EZP_FAMILY,EZP_MODEL,EZP_COLOR,EZP_FINISH,EZP_SIZE,EZP_LENGTH,EZP_WIDTH,EZP_LENGTH_UOM,EZP_WEIGHT,EZP_WEIGHT_UOM,EZP_VOLUME, EZP_VOLUME_UOM,EZP_STYLE,EZP_NEW_FROM,EZP_NEW_TO,EZP_CURR_PRICE,EZP_CURR_EFF_DATE,EZP_FUTURE_PRICE,EZP_FUTURE_EFF_DATE,EZP_FEATURED, EZP_DISCONTINUED,EZP_DISCONTINUE_DATE,EZP_REPLACES_ITEM,EZP_ALTERNATE1,EZP_ALTERNATE2,EZP_ALTERNATE3,EZP_ATTR1,EZP_ATTR2,EZP_ATTR3, EZP_ATTR4,EZP_ATTR5,EZP_SALES_ORG, EZP_PROD_ATTRS,(SELECT EPA_ATTR_VALUE FROM EZC_PRODUCT_ATTRIBUTES WHERE EPA_PRODUCT_CODE=EZP_PRODUCT_CODE AND EPA_ATTR_CODE='DIVISION') DIVISION FROM EZC_CATEGORY_PRODUCTS,EZC_PRODUCTS,EZC_PRODUCT_DESCRIPTIONS WHERE ECP_PRODUCT_CODE = EZP_PRODUCT_CODE AND ECP_CATEGORY_CODE = '"+categoryID+"'  AND  EZP_STATUS NOT IN ('Z2','Z3','01','ZR','ZM','ZL','ZE','ZD','ZP') AND EPD_LANG_CODE= 'EN' AND EPD_PRODUCT_CODE = EZP_PRODUCT_CODE  "+filterQryStr+" ORDER BY PROD_DESC ASC) AS NEWTBL1 ORDER BY PROD_DESC DESC) AS NEWTBL2 ORDER BY EZP_ATTR3 desc";
	if ( classificationID != null && !"null".equals(classificationID))
	query="SELECT * FROM (SELECT TOP "+pageSize+" * FROM (SELECT TOP "+pageMaxNo+" ECP_CLASSIFICATION_CODE, EZP_PRODUCT_CODE,EPD_PRODUCT_DESC PROD_DESC,EZP_TYPE,EZP_SUB_TYPE,EZP_STATUS,EZP_WEB_SKU, EZP_WEB_PROD_ID,EZP_UPC_CODE,EZP_ERP_CODE,EZP_BRAND,EZP_FAMILY,EZP_MODEL,EZP_COLOR,EZP_FINISH,EZP_SIZE, EZP_LENGTH,EZP_WIDTH,EZP_LENGTH_UOM,EZP_WEIGHT,EZP_WEIGHT_UOM,EZP_VOLUME,EZP_VOLUME_UOM,EZP_STYLE,EZP_NEW_FROM, EZP_NEW_TO,EZP_CURR_PRICE,EZP_CURR_EFF_DATE,EZP_FUTURE_PRICE,EZP_FUTURE_EFF_DATE,EZP_FEATURED,EZP_DISCONTINUED, EZP_DISCONTINUE_DATE,EZP_REPLACES_ITEM,EZP_ALTERNATE1,EZP_ALTERNATE2,EZP_ALTERNATE3,EZP_ATTR1,EZP_ATTR2,EZP_ATTR3, EZP_ATTR4,EZP_ATTR5,EZP_SALES_ORG, EZP_PROD_ATTRS,(SELECT EPA_ATTR_VALUE FROM EZC_PRODUCT_ATTRIBUTES WHERE EPA_PRODUCT_CODE=EZP_PRODUCT_CODE AND EPA_ATTR_CODE='DIVISION') DIVISION FROM EZC_CLASSIFICATION_PRODUCTS,EZC_PRODUCTS,EZC_PRODUCT_DESCRIPTIONS WHERE ECP_PRODUCT_CODE = EZP_PRODUCT_CODE AND ECP_CLASSIFICATION_CODE = '"+classificationID+"' AND EZP_STATUS NOT IN ('Z2','Z3','01','ZR','ZM','ZL','ZE','ZD','ZP') AND EPD_LANG_CODE= 'EN' AND EPD_PRODUCT_CODE = EZP_PRODUCT_CODE  "+filterQryStr+" ORDER BY PROD_DESC ASC) AS NEWTBL1 ORDER BY PROD_DESC DESC) AS NEWTBL2 ORDER BY EZP_ATTR3 desc";
	catalogParams.setQuery(query);
	...
	if(catalogProductsRetObj.getRowCount()==0)
	{
		...
		if(fromHeader!=null && !"null".equals(fromHeader))
		{
			...
			catalogParams = new EziMiscParams();
			catalogParams.setIdenKey("MISC_SELECT");
			query="SELECT * FROM (SELECT TOP "+pageSize+" * FROM (SELECT TOP "+pageMaxNo+" ECP_CATEGORY_CODE,EZP_PRODUCT_CODE,EPA_ATTR_VALUE,EPD_PRODUCT_DESC PROD_DESC,EZP_TYPE,EZP_SUB_TYPE,EZP_STATUS,EZP_WEB_SKU,EZP_WEB_PROD_ID,EZP_UPC_CODE,EZP_ERP_CODE,EZP_BRAND,EZP_FAMILY,EZP_MODEL,EZP_COLOR,EZP_FINISH,EZP_SIZE,EZP_LENGTH,EZP_WIDTH,EZP_LENGTH_UOM,EZP_WEIGHT,EZP_WEIGHT_UOM,EZP_VOLUME,EZP_VOLUME_UOM,EZP_STYLE,EZP_NEW_FROM,EZP_NEW_TO,EZP_CURR_PRICE,EZP_CURR_EFF_DATE,EZP_FUTURE_PRICE,EZP_FUTURE_EFF_DATE,EZP_FEATURED,EZP_DISCONTINUED,EZP_DISCONTINUE_DATE,EZP_REPLACES_ITEM,EZP_ALTERNATE1,EZP_ALTERNATE2,EZP_ALTERNATE3,EZP_ATTR1,EZP_ATTR2,EZP_ATTR3,EZP_ATTR4,EZP_ATTR5,EZP_SALES_ORG, EZP_PROD_ATTRS, EZA_LINK,(SELECT EPA_ATTR_VALUE FROM EZC_PRODUCT_ATTRIBUTES WHERE EPA_PRODUCT_CODE=EZP_PRODUCT_CODE AND EPA_ATTR_CODE='DIVISION') DIVISION FROM EZC_CATEGORY_PRODUCTS,EZC_PRODUCTS,EZC_PRODUCT_DESCRIPTIONS,EZC_PRODUCT_ATTRIBUTES AT,EZC_ASSETS,EZC_PRODUCT_ASSETS PA  WHERE ECP_PRODUCT_CODE = EZP_PRODUCT_CODE AND AT.EPA_PRODUCT_CODE = EZP_PRODUCT_CODE AND EZP_PRODUCT_CODE = PA.EPA_PRODUCT_CODE AND EPA_ASSET_ID=EZA_ASSET_ID AND  EPA_IMAGE_TYPE='TN' AND ECP_CATEGORY_CODE = '"+fromHeader+"' AND EPA_ATTR_CODE='DCH_STATUS' AND  EPA_ATTR_VALUE NOT IN ('Z2','Z3','01','ZR','ZM','ZL','ZE','ZD','ZP') AND EPD_LANG_CODE= 'EN' AND EPD_PRODUCT_CODE = EZP_PRODUCT_CODE "+filterQryStr+" ORDER BY PROD_DESC ASC) AS NEWTBL1 ORDER BY PROD_DESC DESC) AS NEWTBL2 ORDER BY PROD_DESC ASC";
			catalogParams.setQuery(query);
	...
	if(productsCntRetObj!=null && productsCntRetObj.getRowCount()>0 )
	{
		for(int c=0;c<productsCntRetObj.getRowCount();c++)
		{
			...
			String statusHMRet   = productsCntRetObj.getFieldValueString(c,"EZP_STATUS");
