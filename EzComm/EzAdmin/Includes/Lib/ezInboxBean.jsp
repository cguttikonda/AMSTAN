...
<jsp:useBean id="ForumsManager_I" class="ezc.client.EzForumsManager" scope="session"/>
<jsp:useBean id="TransManager_I" class="ezc.client.EzTransactionManager" scope="session"/>
