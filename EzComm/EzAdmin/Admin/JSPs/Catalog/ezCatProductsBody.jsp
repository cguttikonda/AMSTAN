<%@ include file="../../../Includes/JSPs/Catalog/iCatProducts.jsp"%>
<%
	//out.println("catProductObj::"+catProductObj.toEzcString());
%>
<style type="text/css" media="screen">
 	...
 	#catProducts_wrapper .fg-toolbar { font-size: 0.8em }
 	#theme_links span { float: left; padding: 2px 10px; }
 	#catProducts_wrapper { -webkit-box-shadow: 2px 2px 6px #666; box-shadow: 2px 2px 6px #666; border-radius: 5px; }
 	#catProducts tbody {
 		border-left: 1px solid #AAA;
 		border-right: 1px solid #AAA;
 	}
 	#catProducts thead th:first-child { border-left: 1px solid #AAA; }
 	#catProducts thead th:last-child { border-right: 1px solid #AAA; }
 </style>
...
$(function(){
	...
	$(document).ready(function() {
		var oTable = $('#catProducts').dataTable();
		var nEditing = null;
		...
		$('#catProducts a.delete').live('click', function (e) {
			e.preventDefault();
		...
		$('#catProducts a.edit').live('click', function (e) {
			e.preventDefault();
...
<table class="data-table" id="catProducts">
	<thead>
	<tr>
		<th>Category Code</th>
		<th>Product Code</th>
	...
	<tbody>
<%
	for(int i=0;i<catProductObj.getRowCount();i++)
	{		
		String catCode = catProductObj.getFieldValueString(i,"ECP_CATEGORY_CODE");
		String productCode = catProductObj.getFieldValueString(i,"ECP_PRODUCT_CODE");
%>		
		<tr>
			<td>&nbsp;<%=catCode%>&nbsp;</td>
			<td>&nbsp;<%=productCode%>&nbsp;</td>
