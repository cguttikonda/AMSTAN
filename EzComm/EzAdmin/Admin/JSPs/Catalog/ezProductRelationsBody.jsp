<%@ include file="../../../Includes/JSPs/Catalog/iProRelations.jsp"%>
<%
	//out.println("proRelationsObj::"+proRelationsObj.toEzcString());
%>
<style type="text/css" media="screen">
 	...
 	#prodRelations_wrapper .fg-toolbar { font-size: 0.8em }
 	#theme_links span { float: left; padding: 2px 10px; }
 	#prodRelations_wrapper { -webkit-box-shadow: 2px 2px 6px #666; box-shadow: 2px 2px 6px #666; border-radius: 5px; }
 	#prodRelations tbody {
 		border-left: 1px solid #AAA;
 		border-right: 1px solid #AAA;
 	}
 	#prodRelations thead th:first-child { border-left: 1px solid #AAA; }
 	#prodRelations thead th:last-child { border-right: 1px solid #AAA; }
 </style>
...
$(function(){
	...
	$("#prodRelations").colResizable({
		...
		onResize:onSampleResized});
			...
			$(document).ready(function() {
				var oTable = $('#prodRelations').dataTable();
				var nEditing = null;
				...
				$('#prodRelations a.delete').live('click', function (e) {
					e.preventDefault();
				...
				$('#prodRelations a.edit').live('click', function (e) {
					e.preventDefault();
...
<table class="data-table" id="prodRelations">
	<thead>
	<tr>
		<th>Product Code</th>
		<th>Product Code</th>
	...
	<tbody>
<%
	for(int i=0;i<proRelationsObj.getRowCount();i++)
	{		
		String prodCode1	= proRelationsObj.getFieldValueString(i,"EPR_PRODUCT_CODE1");
		String prodCode2	= proRelationsObj.getFieldValueString(i,"EPR_PRODUCT_CODE2");
		String relationType	= proRelationsObj.getFieldValueString(i,"EPR_RELATION_TYPE");
		String relationQty	= proRelationsObj.getFieldValueString(i,"EPR_REL_QTY");
%>		
		<tr>
			<td>&nbsp;<%=prodCode1%></td>
			<td>&nbsp;<%=prodCode2%></td>
